...
typedef StringBasedNtupleFiller<pat::Electron> PATEleFiller;
typedef StringBasedNtupleFiller<pat::Muon> PATMuFiller;
typedef StringBasedNtupleFiller<pat::Tau> PATTauFiller;
