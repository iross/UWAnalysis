...
//	TFile *m = new TFile("sandbox/zz-latest/DATA.root");
	...
	TString LEleZ = "dZ12<0.10&&dZ13<0.10&&dZ14<0.10&&HLT_Any&&z1Mass>75&&z1Mass<105&&(z1l1CiCTight&1)==1&&(z1l2CiCTight&1)==1&&z1l1MissHits<2&&z1l2MissHits<2&&z1l1RelPFIsoDB<0.25&&z1l2RelPFIsoDB<0.25&&z1l1Pt>20&&z1l2Pt>10";
	TString LMuZ = "dZ12<0.10&&dZ13<0.10&&dZ14<0.10&&HLT_Any&&z1Mass>75&&z1Mass<105&&z1l1RelPFIsoDB<0.25&&z1l2RelPFIsoDB<0.25&&z1l1Pt>20&&z1l2Pt>10";
	...
	eventTree->Draw("1>>ll(1,1,2)","("+LMuZ+STTZcuts+")*"+tt1+"/(1-"+tt1+")");
	...
	eventTree->Draw("1>>ll(1,1,2)","("+LEleZ+STTZcuts+")*"+tt1+"/(1-"+tt1+")");
	double llv = ll->GetBinContent(1);
	...
	eventTree->Draw("1>>l(1,1,2)","("+LEleZ+SETZcuts+")*"+eletFR+"/(1-"+eletFR+")");
	...
	eventTree->Draw("1>>l(1,1,2)","("+LMuZ+SETZcuts+")*"+eletFR+"/(1-"+eletFR+")");
	double lv = l->GetBinContent(1);
	...
	eventTree->Draw("1>>l(1,1,2)","("+LMuZ+SMTZcuts+")*"+mutFR+"/(1-"+mutFR+")");
	double lv = l->GetBinContent(1);
	...
	eventTree->Draw("1>>l(1,1,2)","("+LEleZ+SMTZcuts+")*"+mutFR+"/(1-"+mutFR+")");
	double lv = l->GetBinContent(1);
