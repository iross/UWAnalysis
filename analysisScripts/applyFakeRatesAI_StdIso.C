...
//	for (iter = frMap.begin(); iter != frMap.end(); ++iter){
...
//	TFile *m = new TFile("sandbox/zz-latest/DATA.root");
	...
	TString LEleZ = "z1l1SIP<4&&z1l2SIP<4&&HLT_Any&&z1Mass>60&&z1Mass<120&&(z1l1CiCTight&1)==1&&(z1l2CiCTight&1)==1&&z1l1MissHits<2&&z1l2MissHits<2&&"+stdIso("z1l1",0.275,"ele")+"&&"+stdIso("z1l2",0.275,"ele")+"&&z1l1Pt>20&&z1l2Pt>10";
	TString LMuZ = "z1l1SIP<4&&z1l2SIP<4&&HLT_Any&&z1Mass>60&&z1Mass<120&&"+stdIso("z1l1",0.275,"mu")+"&&"+stdIso("z1l2",0.275,"mu")+"&&z1l1Pt>20&&z1l2Pt>10";
	...
	TString SEEZcuts_ai = "&&z2l1MissHits<2&&z2l2MissHits<2&&z2l1SIP<4&&z2l2SIP<4&&z2l1Pt>7&&z2l2Pt>7&&z2Charge==0&&!"+stdIso("z2l1",0.275,"ele")+"&&"+stdIso("z2l2",0.275,"ele")+"&&(z2l1CiCTight&1)!=1&&(z2l2CiCTight&1)==1&&z2Mass>60&&z2Mass<120";
	TString SMMZcuts_ai = "&&z2l1SIP<4&&z2l2SIP<4&&z2l1Pt>5&&z2l2Pt>5&&z2Charge==0&&!"+stdIso("z2l1",0.275,"mu")+"&&"+stdIso("z2l2",0.275,"mu")+"&&z2Mass>60&&z2Mass<120";
    //temp IAR 02.Jul.2012
	TString SEMZcuts_ai = "&&z2l1Pt>10&&z2l2Pt>10&&z2l1MissHits<2&&z2Charge==0&&z2l1CiCTight&1==1&&z2l1RelPFIsoDB>0.25&&z2l2RelPFIsoDB<0.25&&z2Mass<90&&dZ12<0.1&&dZ13<0.1&&dZ14<0.1";

	TString STTZcuts_ai = "&&z2l1Pt>20&&z2l2Pt>20&&z2l1EleVeto&&z2l2EleVeto&&!z2l1MediumIsoCombDB&&z2l2MediumIsoCombDB&&z2l1MuVeto&&z2l2MuVeto&&z2Charge==0&&z2Mass>30&&z2Mass<80&&dZ12<0.1&&dZ13<0.1&&dZ14<0.1";
	TString SMTZcuts_ai = "&&z2l2EleVeto&&z2l2LooseIsoCombDB&&z2l2MuVetoTight&&z2l1RelPFIsoDB>0.15&&z2l2Pt>20&&z2l1Pt>10&&z2Charge==0&&z2Mass>30&&z2Mass<80&&dZ12<0.1&&dZ13<0.1&&dZ14<0.1";
	TString SETZcuts_ai = "&z2l2EleVeto&&z2l2LooseIsoCombDB&&z2l2Pt>20&&z2l1Pt>10&&z2l1RelPFIsoDB>0.10&&(z2l1CiCTight&1)==1&&z2l1MissHits==0&&z2l2MuVeto&&z2Charge==0&&z2Mass>30&&z2Mass<80&&dZ12<0.1&&dZ13<0.1&&dZ14<0.1";
	...
	m->cd();
	muMuTauTauEventTree_antiIso1->cd();
	eventTree->Draw("1>>ll(1,1,2)","("+LMuZpf+STTZcuts+")*"+tt1+"/(1-"+tt1+")");
	...
	e->cd();
	eleEleTauTauEventTree_antiIso1->cd();
	eventTree->Draw("1>>ll(1,1,2)","("+LEleZpf+STTZcuts+")*"+tt1+"/(1-"+tt1+")");
	double llv = ll->GetBinContent(1);
	...
	e->cd();
	eleEleEleTauEventTree_antiIso1->cd();
	// need to fix this stuff so that the fake rate for e is applied.
	eventTree->Draw("1>>l(1,1,2)","("+LEleZpf+SETZcuts+")*"+eletFR+"/(1-"+eletFR+")");
	...
	m->cd();
	muMuEleTauEventTree_antiIso1->cd();
	eventTree->Draw("1>>l(1,1,2)","("+LMuZpf+SETZcuts+")*"+eletFR+"/(1-"+eletFR+")");
	double lv = l->GetBinContent(1);
	...
	m->cd();
	muMuMuTauEventTree_antiIso1->cd();
	eventTree->Draw("1>>l(1,1,2)","("+LMuZpf+SMTZcuts+")*"+mutFR+"/(1-"+mutFR+")");
	double lv = l->GetBinContent(1);
	...
	e->cd();
	eleEleMuTauEventTree_antiIso1->cd();
	eventTree->Draw("1>>l(1,1,2)","("+LEleZpf+SMTZcuts+")*"+mutFR+"/(1-"+mutFR+")");
	double lv = l->GetBinContent(1);
	...
	e->cd();
	eleEleEleMuEventTree_antiIso1->cd();
	...
	m->cd();
	muMuEleMuEventTree_antiIso1->cd();
	...
	e->cd();
	eleEleEleEleEventTree_antiIso1->cd();
	...
	m->cd();
	muMuEleEleEventTree_antiIso1->cd();
	...
	e->cd();
	eleEleMuMuEventTree_antiIso1->cd();
