...
mmAI = Selector([
	...
	"((!((z2l1isGlobal||z2l1isTracker)&&z2l1isPF)) || !(z2l1pfCombIso2012<0.40))",
...
mmIA = Selector([
	...
	"((!((z2l2isGlobal||z2l2isTracker)&&z2l2isPF)) || !(z2l2pfCombIso2012<0.40))",
...
eeAI = Selector([
	...
	"((!(z2l1mvaNonTrigPass>0&&z2l1MissHits<2)) || !(z2l1pfCombIso2012<0.40))",
...
eeIA = Selector([
	...
	"((!(z2l2mvaNonTrigPass>0&&z2l2MissHits<2)) || !(z2l2pfCombIso2012<0.40))",
