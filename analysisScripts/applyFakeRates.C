...
#include "/afs/hep.wisc.edu/cms/iross/HZZ2l2tau/CMSSW_4_2_5/src/UWAnalysis/ROOT/macros/ZZLimitsAndYields/helpers.h"
#include <utility>

void main(string case){
...
//	TFile *m = new TFile("sandbox/zz-latest/DATA.root");
	...
	TString LEleZ = "z1l1SIP<4&&z1l2SIP<4&&z2l1SIP<4&&z2l2SIP<4&&HLT_Any&&z1Mass>60&&z1Mass<120&&(z1l1CiCTight&1)==1&&(z1l2CiCTight&1)==1&&z1l1MissHits<2&&z1l2MissHits<2&&"+stdIso("z1l1",0.275,"ele")+"&&"+stdIso("z1l2",0.275,"ele")+"&&z1l1Pt>20&&z1l2Pt>10";
	TString LMuZ = "z1l1SIP<4&&z1l2SIP<4&&z2l1SIP<4&&z2l2SIP<4&&HLT_Any&&z1Mass>60&&z1Mass<120&&"+stdIso("z1l1",0.275,"mu")+"&&"+stdIso("z1l2",0.275,"mu")+"&&z1l1Pt>20&&z1l2Pt>10";

	TString SEEZcuts_aa = "&&z2l1Pt>10&&z2l2Pt>10&&z2Charge==0&&!"+stdIso("z2l1",0.275,"ele")+"&&!"+stdIso("z2l2",0.275,"ele")+"&&(z2l1CiCTight&1)==1&&z2l2CiCTight&1==1&&z2Mass>60&&z2Mass<120";
	TString SMMZcuts_aa = "&&z2l1Pt>10&&z2l2Pt>10&&z2Charge==0&&!"+stdIso("z2l1",0.275,"ele")+"&&!"+stdIso("z2l2",0.275,"mu")+"&&z2Mass>60&&z2Mass<120";
	...
	TString SEEZcuts_ai = "&&z2l1Pt>10&&z2l2Pt>10&&z2Charge==0&&!"+stdIso("z2l1",0.275,"ele")+"&&"+stdIso("z2l2",0.275,"ele")+"&&(z2l1CiCTight&1)==1&&z2l2CiCTight&1==1&&z2Mass>60&&z2Mass<120";
	TString SMMZcuts_ai = "&&z2l1Pt>10&&z2l2Pt>10&&z2Charge==0&&"+stdIso("z2l1",0.275,"ele")+"&&!"+stdIso("z2l2",0.275,"mu")+"&&z2Mass>60&&z2Mass<120";
	...
	TString SEEZcuts_ia = "&&z2l1Pt>10&&z2l2Pt>10&&z2Charge==0&&"+stdIso("z2l1",0.275,"ele")+"&&!"+stdIso("z2l2",0.275,"ele")+"&&(z2l1CiCTight&1)==1&&z2l2CiCTight&1==1&&z2Mass>60&&z2Mass<120";
	TString SMMZcuts_ia = "&&z2l1Pt>10&&z2l2Pt>10&&z2Charge==0&&!"+stdIso("z2l1",0.275,"ele")+"&&"+stdIso("z2l2",0.275,"mu")+"&&z2Mass>60&&z2Mass<120";
