...
//	TFile *m = new TFile("BGStdIso_17May.root");
	...
	TString SEEZcuts_aa = "&&z1l1SIP<4&&z1l2SIP<4&&z2l1MissHits<2&&z2l2MissHits<2&&z2l1SIP<4&&z2l2SIP<4&&z2l1Pt>7&&z2l2Pt>7&&z2Charge==0&&!"+stdIso("z2l1",0.275,"ele")+"&&!"+stdIso("z2l2",0.275,"ele")+"&&z2Mass>60&&z2Mass<120";
//	TString SEEZcuts_aa = "&&z1l1SIP<4&&z1l2SIP<4&&z2l1SIP<4&&z2l2SIP<4&&z2l1Pt>7&&z2l2Pt>7&&z2Charge==0&&z2Mass>60&&z2Mass<120";
	TString SMMZcuts_aa = "&&z1l1SIP<4&&z1l2SIP<4&&z2l1SIP<4&&z2l2SIP<4&&z2l1Pt>5&&z2l2Pt>5&&z2Charge==0&&!"+stdIso("z2l1",0.275,"mu")+"&&!"+stdIso("z2l2",0.275,"mu")+"&&z2Mass>60&&z2Mass<120&&!(z2l1isGlobal&&z2l2isTracker)&&!(z2l2isGlobal&&z2l2isTracker)";
//	TString SMMZcuts_aa = "&&z1l1SIP<4&&z1l2SIP<4&&z2l1SIP<4&&z2l2SIP<4&&z2l1Pt>5&&z2l2Pt>5&&z2Charge==0&&z2Mass>60&&z2Mass<120";
//	std::cout << LMuZ+SMMZcuts_aa << std::endl;
	TString SEMZcuts_aa = "&&z2l1Pt>10&&z2l2Pt>10&&z2l1MissHits<2&&z2Charge==0&&z2l1CiCTight&1==1&&z2l1RelPFIsoDB>0.25&&z2l2RelPFIsoDB>0.25&&z2Mass<90&&dZ12<0.1&&dZ13<0.1&&dZ14<0.1";
	TString STTZcuts_aa = "&&z2l1Pt>20&&z2l2Pt>20&&z2l1EleVeto&&z2l2EleVeto&&!z2l1MediumIsoCombDB&&!z2l2MediumIsoCombDB&&z2l1MuVeto&&z2l2MuVeto&&z2Charge==0&&z2Mass>30&&z2Mass<80&&dZ12<0.1&&dZ13<0.1&&dZ14<0.1";
	TString SMTZcuts_aa = "&&z2l2EleVeto&&!z2l2LooseIsoCombDB&&z2l2MuVetoTight&&z2l1RelPFIsoDB>0.15&&z2l2Pt>20&&z2l1Pt>10&&z2Charge==0&&z2Mass>30&&z2Mass<80&&dZ12<0.1&&dZ13<0.1&&dZ14<0.1";
	TString SETZcuts_aa = "&z2l2EleVeto&&!z2l2LooseIsoCombDB&&z2l2Pt>20&&z2l1Pt>10&&z2l1RelPFIsoDB>0.10&&(z2l1CiCTight&1)==1&&z2l1MissHits==0&&z2l2MuVeto&&z2Charge==0&&z2Mass>30&&z2Mass<80&&dZ12<0.1&&dZ13<0.1&&dZ14<0.1";
//	TString SEMZcuts_aa = "&&dZ13<0.10&&dZ14<0.10&&z2l1Pt>10&&z2l2Pt>10&&z2l1MissHits<2&&z2Charge==0&&z2l1CiCTight&1==1&&!"+stdIso("z2l1",0.275,"ele")+"&&!"+stdIso("z2l2",0.275,"mu")+"&&z2Mass<90";
//	TString STTZcuts_aa = "&&dZ13<0.10&&dZ14<0.10&&z2l1Pt>20&&z2l2Pt>20&&z2l1EleVeto&&z2l2EleVeto&&!z2l1MediumIsoCombDB&&!z2l2MediumIsoCombDB&&z2l1MuVeto&&z2l2MuVeto&&z2Charge==0&&z2Mass>30&&z2Mass<80";
//	TString SMTZcuts_aa = "&&dZ13<0.10&&dZ14<0.10&&z2l2EleVeto&&!z2l2LooseIsoCombDB&&z2l2MuVetoTight&&!"+stdIso("z2l1",0.10,"mu")+"&&z2l2Pt>20&&z2l1Pt>10&&z2Charge==0&&z2Mass>30&&z2Mass<80";
//	TString SETZcuts_aa = "&&dZ13<0.10&&dZ14<0.10&&z2l2EleVeto&&!z2l2LooseIsoCombDB&&z2l2Pt>20&&z2l1Pt>10&&!"+stdIso("z2l1",0.08,"ele")+"&&z2l1CiCTight&1==1&&z2l1MissHits==0&&z2l2MuVeto&&z2Charge==0&&z2Mass>30&&z2Mass<80";
	...
	TString SEEZcuts_ia = "&&z2l1Pt>7&&z2l2Pt>7&&z2Charge==0&&"+stdIso("z2l1",0.275,"ele")+"&&!"+stdIso("z2l2",0.275,"ele")+"&&(z2l1CiCTight&1)==1&&(z2l2CiCTight&1)==1&&z2Mass>12&&z2Mass<120";
...
//	if (case=="AA"){
		...
		cout << LEleZ+SEEZcuts << endl;
//	} else if (case=="AI"){
//		TString SEEZcuts = SEEZcuts_ai; TString SMMZcuts = SMMZcuts_ai; TString SEMZcuts = SEMZcuts_ai;
//		TString STTZcuts = STTZcuts_ai; TString SMTZcuts = SMTZcuts_ai; TString SETZcuts = SETZcuts_ai;
//	} else if (case=="IA"){
...
//	}
	...
	eventTree->Draw("1>>ll(1,1,2)","("+LMuZpf+STTZcuts+")*"+tt1+"*"+tt2+"/(1-"+tt1+"*"+tt2+")");
	...
	eventTree->Draw("1>>ll(1,1,2)","("+LEleZpf+STTZcuts+")*"+tt1+"*"+tt2+"/(1-"+tt1+"*"+tt2+")");
	double llv = ll->GetBinContent(1);
	...
	eventTree->Draw("1>>l(1,1,2)","("+LEleZpf+SETZcuts+")*"+eletFR+"*"+et+"/(1-"+eletFR+"*"+et+")");
	...
	eventTree->Draw("1>>l(1,1,2)","("+LMuZpf+SETZcuts+")*"+eletFR+"*"+et+"/(1-"+eletFR+"*"+et+")");
	double lv = l->GetBinContent(1);
	...
	eventTree->Draw("1>>l(1,1,2)","("+LMuZpf+SMTZcuts+")*"+mutFR+"*"+mt+"/(1-"+mutFR+"*"+mt+")");
	double lv = l->GetBinContent(1);
	...
	eventTree->Draw("1>>l(1,1,2)","("+LEleZpf+SMTZcuts+")*"+mutFR+"*"+mt+"/(1-"+mutFR+"*"+mt+")");
	double lv = l->GetBinContent(1);
	...
	//do some stupid plotting
	e->cd();
	eleEleMuMuEventTree_antiIso->cd();
	eventTree->Draw("z2Mass>>(18,0,90)",LEleZ+SMMZcuts);
	C->SaveAs("FitPlots/z2Mass_temp.png");
	cout <<LMuZ+SMMZcuts<<endl; 
	TH2F* h2d = new TH2F("h2d","h2d",11,40,150,15,0,150);
	h2d->SetMarkerStyle(7);
	h2d->SetMarkerSize(3);
	h2d->GetXaxis()->SetTitle("Z_{1} Mass");
	h2d->GetYaxis()->SetTitle("Z_{2} Mass");
	TLine* l1 = new TLine(60,60,60,120);
	TLine* l2 = new TLine(120,60,120,120);
	TLine* l3 = new TLine(60,60,120,60);
	TLine* l4 = new TLine(60,120,120,120);

	eventTree->Draw("z2Mass:z1Mass>>h2d",LEleZ+SMMZcuts);
	h2d->Draw();
	l1->Draw("same");
	l2->Draw("same");
	l3->Draw("same");
	l4->Draw("same");
	C->SaveAs("FitPlots/2d.png");
}
