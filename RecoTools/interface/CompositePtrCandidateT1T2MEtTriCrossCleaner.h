#ifndef UWAnalysis_RecoTools_CompositePtrCandidateT1T2MEtTriCrossCleaner_h
#define UWAnalysis_RecoTools_CompositePtrCandidateT1T2MEtTriCrossCleaner_h
...
class CompositePtrCandidateT1T2MEtTriCrossCleaner : public edm::EDProducer 
{
 ...
 public:
  ...
  explicit CompositePtrCandidateT1T2MEtTriCrossCleaner(const edm::ParameterSet& cfg)
  {
  ...
  ~CompositePtrCandidateT1T2MEtTriCrossCleaner() {}
  ...
  void produce(edm::Event& evt, const edm::EventSetup& es)
  {
	...
	if(deltaR(*cand.leg1()->leg1(),*cand.leg2())>dR_)
		if(deltaR(*cand.leg1()->leg2(),*cand.leg2())>dR_)
