...
// $Id: PATWWElectronEmbedder.h,v 1.3 2011/07/06 22:08:13 bachtis Exp $
//
//
...
class PATWWElectronEmbedder : public edm::EDProducer {
  ...
  virtual void produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
  {
	...
	if(cands->at(i).isEB()||cands->at(i).isEE()) {
	 ...
	 //hack
	 passID=false;
	 if (electron.electronID("cicTight")==1||electron.electronID("cicTight")==3||electron.electronID("cicTight")==5||electron.electronID("cicTight")==9||electron.electronID("cicTight")==13||electron.electronID("cicTight")==15) passID=true;
	if(passID)
