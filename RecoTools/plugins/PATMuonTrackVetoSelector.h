...
// $Id: PATMuonTrackVetoSelector.h,v 1.1.1.1 2010/04/16 10:07:30 bachtis Exp $
//
//
...
class PATMuonTrackVetoSelector : public edm::EDProducer {
   public:
      explicit PATMuonTrackVetoSelector(const edm::ParameterSet&);
      ~PATMuonTrackVetoSelector();
   ...
   private:
      ...
      double minVetoValue_;
      double maxVetoValue_;
