#ifndef UWAnalysis_RecoTools_QuadCandInvMassSelector_h
#define UWAnalysis_RecoTools_QuadCandInvMassSelector_h
	...
	void produce(edm::Event& evt, const edm::EventSetup& es)
	{
		...
		for(unsigned int i=0;i<collection->size();++i) {
			...
			if (((cand.leg1()->leg1()->p4())+(cand.leg1()->leg2()->p4())).M() > minMll_)
				if (((cand.leg1()->leg1()->p4())+(cand.leg2()->leg1()->p4())).M() > minMll_)
					if (((cand.leg1()->leg1()->p4())+(cand.leg2()->leg2()->p4())).M() > minMll_)
						if (((cand.leg1()->leg2()->p4())+(cand.leg2()->leg1()->p4())).M() > minMll_)
							if (((cand.leg1()->leg2()->p4())+(cand.leg2()->leg2()->p4())).M() > minMll_)
