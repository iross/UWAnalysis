...
typedef CompositePtrCandidateT1T2MEtProducer<reco::RecoChargedCandidate, reco::RecoChargedCandidate> PATTrackTrackPairProducer;
...
typedef CompositePtrCandidateT1T2MEtProducer<PATElecPair,PATElectronNuPair> PATEleEleEleNuQuadProducer;
...
DEFINE_FWK_MODULE(PATTrackTrackPairProducer);
...
DEFINE_FWK_MODULE(PATEleEleMuNuQuadProducer);
