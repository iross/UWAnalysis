...
print '{0:>10} {1:>10} {2:>10} {3:>10} {4:>10} {5:>10} {6:>10} {7:>10} {8:>10} {9:>10} {10:>10} {11:>10}'.format("Event","mass","z1mass","z2mass","z1l1Pt","z1l2Pt","z2l1Pt","z2l2Pt","jet1pt","jet2pt","nJets","fisher")

for evt in mmmm_tree:
    if evt.EVENT in missing_events:
        print '{0:10} {1:10f} {2:10f} {3:10f} {4:10f} {5:10f} {6:10f} {7:10f} {8:10f} {9:10f} {10:10f} {11:10f}'.format( 
                evt.EVENT, evt.mass, evt.z1Mass, evt.z2Mass, evt.z1l1Pt, evt.z1l2Pt, evt.z2l1Pt, evt.z2l2Pt, evt.VBFjets_jet1pt, evt.VBFjets_jet2pt, evt.VBFjets, evt.VBFjets_fisher)
