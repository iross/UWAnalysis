...
#rom UWAnalysis.Configuration.tools.zzNtupleTools import addMuMuMuTauEventTree
...
#ddMuMuMuTauEventTree(process,'muMuMuTauEventTreeID','MMMTzzTauID')
...
#rom UWAnalysis.Configuration.tools.zzNtupleTools import addMuMuMuMuEventTree
#ddMuMuMuMuEventTree(process,'muMuMuMuEventTree','MMMMzzCleanedCandsAboveThreshold')
