makeZEMShapes(TString filename,TString tree,TString var,int bins,float min,float max)
{
  ...
  visNom->makeShape("sandbox/zem-latest/ggH130.root",tree,var,preselection,"__WEIGHT__*36","GGH130",0.00524545);
  ...
  visNom->makeShape("sandbox/zem-latest/ggH180.root",tree,var,preselection,"__WEIGHT__*36","GGH180",0.00569091);
  visNom->makeShape("sandbox/zem-latest/ggH200.root",tree,var,preselection,"__WEIGHT__*36","GGH200",0.00557273);
  visNom->makeShape("sandbox/zem-latest/ggH250.root",tree,var,preselection,"__WEIGHT__*36","GGH250",0.00493636);
  visNom->makeShape("sandbox/zem-latest/ggH300.root",tree,var,preselection,"__WEIGHT__*36","GGH300",0.0041);
  visNom->makeShape("sandbox/zem-latest/ggH350.root",tree,var,preselection,"__WEIGHT__*36","GGH350",0.00337273);
  visNom->makeShape("sandbox/zem-latest/ggH400.root",tree,var,preselection,"__WEIGHT__*36","GGH400",0.00276364);
  visNom->makeShape("sandbox/zem-latest/ggH450.root",tree,var,preselection,"__WEIGHT__*36","GGH450",0.00252727);
  ...
  visNom->makeShape("sandbox/zem-latest/bbA130.root",tree,var,preselection,"__WEIGHT__*36","BBA130",0.00572727);
  visNom->makeShape("sandbox/zem-latest/bbA140.root",tree,var,preselection,"__WEIGHT__*36","BBA140",0.00656364);
  visNom->makeShape("sandbox/zem-latest/bbA160.root",tree,var,preselection,"__WEIGHT__*36","BBA160",0.00668);
  visNom->makeShape("sandbox/zem-latest/bbA180.root",tree,var,preselection,"__WEIGHT__*36","BBA180",0.00662727);
  ...
  visNom->makeShape("sandbox/zem-latest/bbA400.root",tree,var,preselection,"__WEIGHT__*36","BBA400",0.00339817);
