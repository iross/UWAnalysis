...
eventTree->Draw("1>>ll(1,1,2)","("+LMuZ+STTZcuts+")*"+tt1+"*"+tt2+"/(1-"+tt1+"*"+tt2+")*__WEIGHT__*1000");
double llv = ll->GetBinContent(1);
eventTree->Draw("1>>lle(1,1,2)","("+LMuZ+STTZcuts+")*"+tt1+"^2*"+tt2+"^2*__WEIGHT__*1000");
double llev1 = lle->GetBinContent(1);
eventTree->Draw("1>>lle(1,1,2)","("+LMuZ+STTZcuts+")*"+tte1+"*"+tt2+"*__WEIGHT__*1000");
double llev2 = lle->GetBinContent(1);
eventTree->Draw("1>>lle(1,1,2)","("+LMuZ+STTZcuts+")*"+tt1+"*"+tte2+"*__WEIGHT__*1000");
...
e->cd();
eleEleTauTauEventTreeID->cd();
eventTree->Draw("1>>ll(1,1,2)","("+LEleZ+STTZcuts+")*"+tt1+"*"+tt2+"/(1-"+tt1+"*"+tt2+")*__WEIGHT__*1000");
double llv = ll->GetBinContent(1);
eventTree->Draw("1>>lle(1,1,2)","("+LEleZ+STTZcuts+")*"+tt1+"^2*"+tt2+"^2*__WEIGHT__*1000");
double llev1 = lle->GetBinContent(1);
eventTree->Draw("1>>lle(1,1,2)","("+LEleZ+STTZcuts+")*"+tte1+"*"+tt2+"*__WEIGHT__*1000");
double llev2 = lle->GetBinContent(1);
eventTree->Draw("1>>lle(1,1,2)","("+LEleZ+STTZcuts+")*"+tt1+"*"+tte2+"*__WEIGHT__*1000");
double llev3 = lle->GetBinContent(1);
double llev = sqrt(llev1+llev2*llev2+llev3*llev3);
cout << "Z+Jets Background for EETT = " << llv << " +- " << llev << endl;
e->cd();
eleEleEleTauEventTreeID->cd();
eventTree->Draw("1>>l(1,1,2)","("+LEleZ+SETZcuts+")*"+et+"/(1-"+et+")*__WEIGHT__*1000");
double lv = l->GetBinContent(1);
eventTree->Draw("1>>le(1,1,2)","("+LEleZ+SETZcuts+")*"+et+"^2*__WEIGHT__*1000");
double ler1 = le->GetBinContent(1);
eventTree->Draw("1>>le(1,1,2)","("+LEleZ+SETZcuts+")*"+ete+"*__WEIGHT__*1000");
...
eventTree->Draw("1>>l(1,1,2)","("+LMuZ+SETZcuts+")*"+et+"/(1-"+et+")*__WEIGHT__*1000");
double lv = l->GetBinContent(1);
eventTree->Draw("1>>le(1,1,2)","("+LMuZ+SETZcuts+")*"+et+"^2*__WEIGHT__*1000");
double ler1 = le->GetBinContent(1);
eventTree->Draw("1>>le(1,1,2)","("+LMuZ+SETZcuts+")*"+ete+"*__WEIGHT__*1000");
double ler2 = le->GetBinContent(1);
double ler = sqrt(ler1+ler2*ler2);
cout << "Z+Jets Background for MMET = " << lv << " +- " << ler << endl;
m->cd();
muMuMuTauEventTreeID->cd();
eventTree->Draw("1>>l(1,1,2)","("+LMuZ+SMTZcuts+")*"+mt+"/(1-"+mt+")*__WEIGHT__*1000");
double lv = l->GetBinContent(1);
eventTree->Draw("1>>le(1,1,2)","("+LMuZ+SMTZcuts+")*"+mt+"^2*__WEIGHT__*1000");
double ler1 = le->GetBinContent(1);
eventTree->Draw("1>>le(1,1,2)","("+LMuZ+SMTZcuts+")*"+mte+"*__WEIGHT__*1000");
double ler2 = le->GetBinContent(1);
double ler = sqrt(ler1+ler2*ler2);
cout << "Z+Jets Background for MMMT = " << lv << " +- " << ler << endl;
e->cd();
eleEleMuTauEventTreeID->cd();
eventTree->Draw("1>>l(1,1,2)","("+LEleZ+SMTZcuts+")*"+mt+"/(1-"+mt+")*__WEIGHT__*1000");
double lv = l->GetBinContent(1);
eventTree->Draw("1>>le(1,1,2)","("+LEleZ+SMTZcuts+")*"+mt+"^2*__WEIGHT__*1000");
double ler1 = le->GetBinContent(1);
eventTree->Draw("1>>le(1,1,2)","("+LEleZ+SMTZcuts+")*"+mte+"*__WEIGHT__*1000");
double ler2 = le->GetBinContent(1);
double ler = sqrt(ler1+ler2*ler2);
