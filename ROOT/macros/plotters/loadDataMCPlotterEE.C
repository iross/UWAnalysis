{
	...
	EEEEplotter->addFile("eleEleTauTauEventTreeID/eventTree","/scratch/iross/HZZ/6Jul/VV.root","EWK WW/WZ","__WEIGHT__",0,kRed+2,kRed+4);
	EEEEplotter->addFile("eleEleTauTauEventTreeID/eventTree","/scratch/iross/HZZ/6Jul/DYJets.root","Z+jets","__WEIGHT__",0,kViolet-5,kRed+4);
	// EEEEplotter->addFile("eleEleTauTauEventTreeID/eventTree","/scratch/iross/HZZ/6Jul/QCDJets.root","QCDjets","__WEIGHT__",0,kAzure-1,kRed+4);
	// EEEEplotter->addFile("eleEleTauTauEventTreeID/eventTree","/scratch/iross/HZZ/6Jul/Z2or3Jets.root","Z+jets","__WEIGHT__",0,kViolet-5,kViolet+3);
	// EEEEplotter->addFile("eleEleTauTauEventTreeID/eventTree","/scratch/iross/HZZ/6Jul/ZpBorC.root","Z+bc","__WEIGHT__",0,kViolet-2,kViolet+3);  
	EEEEplotter->addFile("eleEleTauTauEventTreeID/eventTree","/scratch/iross/HZZ/6Jul/TOP.root","t#bar{t}","__WEIGHT__",0,kGreen+2,kGreen+2);
	EEEEplotter->addFile("eleEleTauTauEventTreeID/eventTree","/scratch/iross/HZZ/6Jul/ZZ.root","EWK ZZ","__WEIGHT__",0,kOrange+7,kOrange+3);
	...
	// EEEEplotter->addFile("eleEleTauTauEventTreeID/eventTree","/scratch/iross/HZZ/6Jul/ggH200.root","H(200)#rightarrow ZZ","__WEIGHT__",-1,kOrange-2,kBlack);
	...
	EEEEplotter->addFile("eleEleTauTauEventTreeID/eventTree","/scratch/iross/HZZ/6Jul/EE_DATA.root","DATA","1",1,kBlack,1);
}
