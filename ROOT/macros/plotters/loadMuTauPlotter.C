{
  ...
  //    plotter->addFile("muTauEventTree/eventTree","sandbox/ztt-latest/QCD.root","QCD","2*__WEIGHT__*__CORR__",0,kMagenta-10,1);
    plotter->addFile("muTauEventTree/eventTree","sandbox/ztt-latest/VV.root","Electroweak","__WEIGHT__",0,kRed+2,1);
    plotter->addFile("muTauEventTree/eventTree","sandbox/ztt-latest/W.root","Electroweak","__WEIGHT__",0,kRed+2,1);
    plotter->addFile("muTauEventTree/eventTree","sandbox/ztt-latest/TOP.root","t#bar{t}","__WEIGHT__",0,kBlue-8,1);
    plotter->addFile("muTauEventTree/eventTree","sandbox/ztt-latest/ZJETS.root","Z#rightarrow #tau #tau","__WEIGHT__",0,kOrange-4,kBlack);
  ...
  //STANDARD MODEL
         ...
         plotter->addFile("muTauEventTree/eventTree","sandbox/ztt-latest/sm115.root","10xSM H(115) #rightarrow #tau #tau","13.8*__WEIGHT__*__CORR__",-1,kBlue,kBlue);
 ...
 //Higgs MC studies
  plotterH->addFile("muTauEventTree/eventTree","sandbox/ztt-latest/ZJETS.root","Z #rightarrow #tau #tau","__WEIGHT__*(genTaus>0)",-1,kRed,1,1001); 
  plotterH->addFile("muTauEventTree/eventTree","sandbox/ztt-latest/sm120.root","ggH #rightarrow #tau#tau","__WEIGHT__",-1,kBlue,1);
  plotterH->addFile("muTauEventTree/eventTree","sandbox/ztt-latest/vbf120.root","qqH #rightarrow #tau #tau","__WEIGHT__",-1,kGreen,1);
