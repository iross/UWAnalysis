{
    ...
    ESEEplotter->addFile("eleSCEleEleEventTree/eventTree","/Users/austin/Desktop/HiggsZZ/dataSamples/ZJets.root","Z+Jets","__WEIGHT__noPU",0,kViolet-5,kViolet+3);
    ...
    ESEEplotter->addFile("eleSCEleEleEventTree/eventTree","/Users/austin/Desktop/HiggsZZ/dataSamples/ggHZZ4l.root","H(125) #rightarrow ZZ","__WEIGHT__ * ( abs(gz1l1PdgId) == 11 && abs(gz1l2PdgId) == 11 && abs(gz2l1PdgId) == 11 && abs(gz2l2PdgId) == 11)",-1,kBlue-4,kBlack);
