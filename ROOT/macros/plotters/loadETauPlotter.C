{
  ...
  plotter->addFile("eleTauEventTree/eventTree","sandbox/zet-latest/QCD.root","QCD","__WEIGHT__",0,kViolet-5,kViolet+3);
  plotter->addFile("eleTauEventTree/eventTree","sandbox/zet-latest/EWK.root"," t#bar{t}/ewk","__WEIGHT__",0,kRed+2,kRed+4);
  plotter->addFile("eleTauEventTree/eventTree","sandbox/zet-latest/ZEE.root","Z+jets","__WEIGHT__",0,kOrange+7,kOrange+3);
  plotter->addFile("eleTauEventTree/eventTree","sandbox/zet-latest/ZTTD6TPH.root","Z #rightarrow #tau #tau","__WEIGHT__",-1,kOrange-2,kBlack);
   ...
   // // // //120
     plotter->addFile("eleTauEventTree/eventTree","sandbox/zet-latest/ggH120.root","#Phi(120) #rightarrow #tau #tau","21.5*__WEIGHT__",-1,kGreen+2,kGreen+2);
     plotter->addFile("eleTauEventTree/eventTree","sandbox/zet-latest/bbA120.root","","31.6*__WEIGHT__",-1,kGreen+2,kGreen+2);
     plotter->addFile("eleTauEventTree/eventTree","sandbox/zet-latest/ggH130.root","","2.66*__WEIGHT__",-1,kGreen+2,kGreen+2);
     plotter->addFile("eleTauEventTree/eventTree","sandbox/zet-latest/bbA130.root","","0.93*__WEIGHT__",-1,kGreen+2,kGreen+2);
  ...
  plotter->addFile("eleTauEventTree/eventTree","sandbox/zet-latest/DATA.root","DATA","1",1,kBlack,1);
  ...
  // plotterZENR->addFile("eleTauEventTree/eventTree","sandbox/zet-latest/NO_Z.root"," Others","__WEIGHT__",0,24,24);
  //  plotterZENR->addFile("eleTauEventTree/eventTree","sandbox/zet-latest/ZEE.root","Z+jets","__WEIGHT__",0,30.30);
  //  plotterZENR->addFile("eleTauEventTree/eventTree","sandbox/zet-latest/DATA.root","DATA","1",1,kBlack,1);


  SimplePlotter *plotterWENR = new SimplePlotter();
  plotterWENR->addFile("eleTauEventTree/eventTree","sandbox/zet-latest/NO_W.root"," Others","__WEIGHT__",0,kViolet-5,kViolet+2);
  plotterWENR->addFile("eleTauEventTree/eventTree","sandbox/zet-latest/WEN.root","W+jets","__WEIGHT__",0,kOrange+7,kOrange+3);
  plotterWENR->addFile("eleTauEventTree/eventTree","sandbox/zet-latest/DATA.root","DATA","1",1,kBlack,1);


  SimplePlotter *plotterTOPENR = new SimplePlotter();

  plotterTOPENR->addFile("eleTauEventTree/eventTree","sandbox/zet-latest/NO_TOP.root"," Others","__WEIGHT__",0,24,24);
  plotterTOPENR->addFile("eleTauEventTree/eventTree","sandbox/zet-latest/TOP.root","t#bar{t}","__WEIGHT__",0,30,30);
  plotterTOPENR->addFile("eleTauEventTree/eventTree","sandbox/zet-latest/DATA.root","DATA","1",1,kBlack,1);





  SimplePlotter *plotterZEE = new SimplePlotter();
  plotterZEE->addFile("eleTauEventTree/eventTree","sandbox/z-rej/ZTT.root"," Z #rigghtarrow #tau #tau","__WEIGHT__",0,kRed,kRed);
  plotterZEE->addFile("eleTauEventTree/eventTree","sandbox/z-rej/ZEE.root","Z #rightarrow ee","__WEIGHT__",0,kBlack,1);
