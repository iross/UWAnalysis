#ifndef UWAnalysis_PatTools_CompositePtrCandidateT1T2MEtProducer_h
#define UWAnalysis_PatTools_CompositePtrCandidateT1T2MEtProducer_h
...
#include "UWAnalysis/PatTools/interface/CompositePtrCandidateT1T2MEtVertexAlgorithm.h"
