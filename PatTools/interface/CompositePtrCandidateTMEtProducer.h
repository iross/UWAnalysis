#ifndef UWAnalysis_PatTools_CompositePtrCandidateTMEtProducer_h
#define UWAnalysis_PatTools_CompositePtrCandidateTMEtProducer_h
...
#include "UWAnalysis/PatTools/interface/CompositePtrCandidateTMEtAlgorithm.h"
