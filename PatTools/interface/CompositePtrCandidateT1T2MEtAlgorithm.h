#ifndef UWAnalysis_PatTools_CompositePtrCandidateT1T2MEtAlgorithm_h
#define UWAnalysis_PatTools_CompositePtrCandidateT1T2MEtAlgorithm_h
...
#include "UWAnalysis/PatTools/interface/candidateAuxFunctions.h"
#include "UWAnalysis/PatTools/interface/METCalibrator.h"
 ...
 private: 
  ...
  void computeVBFVariables(CompositePtrCandidateT1T2MEt<T1,T2>& compositePtrCandidate,const JetPtrVector& jets) {
	...
	if(jets.at(0)->eta()*jets.at(1)->eta()<0) {
      ...
      compositePtrCandidate.setVBFVariables(mass,deta,jets20,jets30,pt1,pt2,eta1,eta2);
  }
