...
#ifndef UWAnalysis_PatTools_DiCandidatePairSelector_h
#define UWAnalysis_PatTools_DiCandidatePairSelector_h
...
typedef SingleObjectSelector<
            std::vector<PATEleSCEleEleQuad>,
            StringCutObjectSelector<PATEleSCEleEleQuad>
        > PATEleSCEleEleQuadSelector;
