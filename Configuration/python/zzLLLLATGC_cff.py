...
MMEEanalysisConfigurator.addSelector('MMEEzzEleIso','PATMuMuEleEleQuadSelector','((leg2.leg1.isolationR03().emEt-leg2.leg1.userFloat("rho")*(0.101)+leg2.leg1.isolationR03().hadEt-leg2.leg1.userFloat("rho")*(0.072) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.40)&&((leg2.leg2.isolationR03().emEt-leg2.leg2.userFloat("rho")*(0.101)+leg2.leg2.isolationR03().hadEt-leg2.leg2.userFloat("rho")*(0.072) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.40)','MMEEZEleIso')
...
EEEEanalysisConfigurator.addSelector('EEEEzzEleIso','PATEleEleEleEleQuadSelector','((leg1.leg1.isolationR03().emEt-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.isolationR03().hadEt-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.isolationR03().emEt-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.isolationR03().hadEt-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','EEEELeadingZEleIso')
...
EEEEanalysisConfigurator.addSelector('EEEEzzEleIso2','PATEleEleEleEleQuadSelector','((leg2.leg1.isolationR03().emEt-leg2.leg1.userFloat("rho")*(0.101)+leg2.leg1.isolationR03().hadEt-leg2.leg1.userFloat("rho")*(0.072) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.40)&&((leg1.leg2.isolationR03().emEt-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.isolationR03().hadEt-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','EEEESecondZEleIso')
...
EEMManalysisConfigurator.addSelector('EEMMzzEleIso','PATEleEleMuMuQuadSelector','((leg1.leg1.isolationR03().emEt-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.isolationR03().hadEt-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.isolationR03().emEt-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.isolationR03().hadEt-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','EEMMLeadingZEleIso')
