...
MMEEanalysisConfigurator.addSelector('MMEEzzCleanedMuID','PATMuMuEleEleQuadSelector','leg1.leg1.isGlobalMuon()&&leg1.leg1.isTrackerMuon()&&leg1.leg2.isTrackerMuon()','MMEELeadingZMuID')
MMEEanalysisConfigurator.addSelector('MMEEzzMuIso','PATMuMuEleEleQuadSelector','((leg1.leg1.isolationR03.emEt-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.isolationR03.hadEt-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.isolationR03.emEt-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.isolationR03.hadEt-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','MMEELeadingZMuIso')
...
MMEEanalysisConfigurator.addSelector('MMEEzzEleIso','PATMuMuEleEleQuadSelector','((leg2.leg1.dr03EcalRecHitSumEt-leg2.leg1.userFloat("rho")*(0.101)+leg2.leg1.dr03HcalTowerSumEt-leg2.leg1.userFloat("rho")*(0.072) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.40)&&((leg2.leg2.dr03EcalRecHitSumEt-leg2.leg2.userFloat("rho")*(0.101)+leg2.leg2.dr03HcalTowerSumEt-leg2.leg2.userFloat("rho")*(0.072) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.40)','MMEEZEleIso')
MMEEanalysisConfigurator.addSorter('MMEEzzCleanedCandsSortedByZMass','PATMuMuEleEleQuadSorterByZMass')
MMEEanalysisConfigurator.addSelector('MMEEzzSIP','PATMuMuEleEleQuadSelector','leg1.leg1.userFloat("SIP3D")<4&&leg1.leg2.userFloat("SIP3D")<4&&leg2.leg1.userFloat("SIP3D")<4&&leg2.leg2.userFloat("SIP3D")','MMEESIP')
...
MMMManalysisConfigurator.addSelector('MMMMzzCleanedMuID','PATMuMuMuMuQuadSelector','leg1.leg1.isGlobalMuon()&&leg1.leg1.isTrackerMuon()&&leg1.leg2.isTrackerMuon()','MMMMLeadingZMuID')
...
MMMManalysisConfigurator.addSelector('MMMMzzMuIso2','PATMuMuMuMuQuadSelector','((leg2.leg1.isolationR03.emEt-leg2.leg1.userFloat("rho")*(0.087)+leg2.leg1.isolationR03.hadEt-leg2.leg1.userFloat("rho")*(0.059) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.40)&&((leg2.leg2.isolationR03.emEt-leg2.leg2.userFloat("rho")*(0.087)+leg2.leg2.isolationR03.hadEt-leg2.leg2.userFloat("rho")*(0.059) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.40)','MMMMSecondZMuIso')
MMMManalysisConfigurator.addSorter('MMMMzzCleanedCandsSortedByZMass','PATMuMuMuMuQuadSorterByZMass')
MMMManalysisConfigurator.addSelector('MMMMzzSIP','PATMuMuMuMuQuadSelector','leg1.leg1.userFloat("SIP3D")<4&&leg1.leg2.userFloat("SIP3D")<4&&leg2.leg1.userFloat("SIP3D")<4&&leg2.leg2.userFloat("SIP3D")','MMMMSIP')
...
EEEEanalysisConfigurator.addSelector('EEEEzzEleIso','PATEleEleEleEleQuadSelector','((leg1.leg1.dr03EcalRecHitSumEt-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.dr03HcalTowerSumEt-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.dr03EcalRecHitSumEt-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.dr03HcalTowerSumEt-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','EEEELeadingZEleIso')
...
EEEEanalysisConfigurator.addSelector('EEEEzzEleIso2','PATEleEleEleEleQuadSelector','((leg2.leg1.dr03EcalRecHitSumEt-leg2.leg1.userFloat("rho")*(0.101)+leg2.leg1.dr03HcalTowerSumEt-leg2.leg1.userFloat("rho")*(0.072) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.40)&&((leg2.leg2.dr03EcalRecHitSumEt-leg2.leg2.userFloat("rho")*(0.101)+leg2.leg2.dr03HcalTowerSumEt-leg2.leg2.userFloat("rho")*(0.072) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.40)','EEEESecondZEleIso')
EEEEanalysisConfigurator.addSorter('EEEEzzCleanedCandsSortedByZMass','PATEleEleEleEleQuadSorterByZMass')
EEEEanalysisConfigurator.addSelector('EEEEzzSIP','PATEleEleEleEleQuadSelector','leg1.leg1.userFloat("SIP3D")<4&&leg1.leg2.userFloat("SIP3D")<4&&leg2.leg1.userFloat("SIP3D")<4&&leg2.leg2.userFloat("SIP3D")','EEEESIP')
...
EEMManalysisConfigurator.addSelector('EEMMzzEleIso','PATEleEleMuMuQuadSelector','((leg1.leg1.dr03EcalRecHitSumEt-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.dr03HcalTowerSumEt-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.dr03EcalRecHitSumEt-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.dr03HcalTowerSumEt-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','EEMMLeadingZEleIso')
...
EEMManalysisConfigurator.addSelector('EEMMzzMuIso2','PATEleEleMuMuQuadSelector','((leg2.leg1.isolationR03.emEt-leg2.leg1.userFloat("rho")*(0.087)+leg2.leg1.isolationR03.hadEt-leg2.leg1.userFloat("rho")*(0.059) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.40)&&((leg2.leg2.isolationR03.emEt-leg2.leg2.userFloat("rho")*(0.087)+leg2.leg2.isolationR03.hadEt-leg2.leg2.userFloat("rho")*(0.059) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.40)','EEMMLeadingZMuIso')
EEMManalysisConfigurator.addSorter('EEMMzzCleanedCandsSortedByZMass','PATEleEleMuMuQuadSorterByZMass')
EEMManalysisConfigurator.addSelector('EEMMzzSIP','PATEleEleMuMuQuadSelector','leg1.leg1.userFloat("SIP3D")<4&&leg1.leg2.userFloat("SIP3D")<4&&leg2.leg1.userFloat("SIP3D")<4&&leg2.leg2.userFloat("SIP3D")','EEMMSIP')
...
MMMTanalysisConfigurator.addDiCandidateModule('MMMTzzCands','PATMuMuMuTauQuadProducer','MMMTosDiMuons','MMMTmuTau','smearedMET','smearedJets',1,9999,text='MMMTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
