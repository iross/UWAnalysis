...
def addMuMuTauTauEventTree(process,name,src = 'zzCleanedCandsAboveThreshold', srcEEEE='zzCleanedCandsAboveThreshold', srcEEMM='zzCleanedCandsAboveThreshold', srcMMEE='zzCleanedCandsAboveThreshold', srcMMMM='zzCleanedCandsAboveThreshold'):
	...
	eventTree = cms.EDAnalyzer('EventTreeMaker',
		...
		mumuStdIsoEcalTest = cms.PSet(
			pluginType = cms.string("PATMuMuTauTauQuadFiller"),
			src        = cms.InputTag(src),
			tag        = cms.string("z1l1StdIsoECal"),
			method     = cms.string("leg1.leg1.ecalIso()"),
			leadingOnly=cms.untracked.bool(True)
		),
		mumuStdIsoHcalTest = cms.PSet(
			pluginType = cms.string("PATMuMuTauTauQuadFiller"),
			src        = cms.InputTag(src),
			tag        = cms.string("z1l1StdIsoHCal"),
			method     = cms.string("leg1.leg1.hcalIso()"),
			leadingOnly=cms.untracked.bool(True)
		),
		mumuStdIsoTkTest = cms.PSet(
			pluginType = cms.string("PATMuMuTauTauQuadFiller"),
			src        = cms.InputTag(src),
			tag        = cms.string("z1l1StdIsoTk"),
			method     = cms.string("leg1.leg1.trackIso()"),
			leadingOnly=cms.untracked.bool(True)
		),
...
#			leadingOnly=cms.untracked.bool(True)
#		),
#		eleeleStdIsoEcalTest2 = cms.PSet(
#			pluginType = cms.string("PATEleEleEleTauQuadFiller"),
#			src        = cms.InputTag(src),
#			tag        = cms.string("z2l1StdIsoECal"),
#			method     = cms.string("leg2.leg1.ecalIso()"),
#			leadingOnly=cms.untracked.bool(True)
#		),
#		eleeleStdIsoHcalTest2 = cms.PSet(
#			pluginType = cms.string("PATEleEleEleTauQuadFiller"),
#			src        = cms.InputTag(src),
#			tag        = cms.string("z2l1StdIsoHCal"),
#			method     = cms.string("leg2.leg1.hcalIso()"),
#			leadingOnly=cms.untracked.bool(True)
#		),
#		eleeleStdIsoTkTest2 = cms.PSet(
#			pluginType = cms.string("PATEleEleEleTauQuadFiller"),
#			src        = cms.InputTag(src),
#			tag        = cms.string("z2l1StdIsoTk"),
#			method     = cms.string("leg2.leg1.trackIso()"),
#			leadingOnly=cms.untracked.bool(True)
#		),
		eleelept = cms.PSet(
		   pluginType = cms.string("PATEleEleEleTauQuadFiller"),
...
def addEleEleMuMuEventTree(process,name,src = 'zzCleanedCandsAboveThreshold', srcEEEE='zzCleanedCandsAboveThreshold', srcEEMM='zzCleanedCandsAboveThreshold', srcMMEE='zzCleanedCandsAboveThreshold', srcMMMM='zzCleanedCandsAboveThreshold'):
	...
	eventTree = cms.EDAnalyzer('EventTreeMaker',
		...
		eleeleTkSum = cms.PSet(
			pluginType = cms.string("PATEleEleMuMuQuadFiller"),
			src        = cms.InputTag(src),
			tag        = cms.string("z1l2TkSum"),
			method     = cms.string("leg1.leg2.dr03TkSumPt()"),
		    leadingOnly=cms.untracked.bool(True)
		),
		eleeleEcalSum = cms.PSet(
			pluginType = cms.string("PATEleEleMuMuQuadFiller"),
			src        = cms.InputTag(src),
			tag        = cms.string("z1l2ECal"),
			method     = cms.string("leg1.leg2.dr03EcalRecHitSumEt()"),
		    leadingOnly=cms.untracked.bool(True)
		),
		eleeleHcalSum = cms.PSet(
			pluginType = cms.string("PATEleEleMuMuQuadFiller"),
			src        = cms.InputTag(src),
			tag        = cms.string("z1l2HCal"),
			method     = cms.string("leg1.leg2.dr03HcalTowerSumEt()"),
		    leadingOnly=cms.untracked.bool(True)
		),
		eleeleRelIso03B1 = cms.PSet(
			pluginType = cms.string("PATEleEleMuMuQuadFiller"),
