...
MMMtri.addDiCandidateModule('triMMMzzCands','PATMuMuMuTriProducer','triMMMosDiMuons','smearedMuons','smearedMET','smearedJets',1,9999,text='MMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMMtri.addSelector('triMMMzzMuID','PATMuMuMuTriSelector','(leg1.leg1.isGlobalMuon()||leg1.leg1.isTrackerMuon())&&(leg1.leg2.isGlobalMuon()||leg1.leg2.isTrackerMuon())','MMMLeadingZMuID')
MMMtri.addSelector('triMMMzzMuIso','PATMuMuMuTriSelector','((leg1.leg1.isolationR03.emEt-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.isolationR03.hadEt-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.isolationR03.emEt-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.isolationR03.hadEt-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMMLeadingZMuIso')
...
MMEtri.addDiCandidateModule('triMMEzzCands','PATMuMuEleTriProducer','triMMEosDiMuons','smearedElectrons','smearedMET','smearedJets',1,9999,text='MMEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMEtri.addSelector('triMMEzzMuID','PATMuMuEleTriSelector','(leg1.leg1.isGlobalMuon()||leg1.leg1.isTrackerMuon())&&(leg1.leg2.isGlobalMuon()||leg1.leg2.isTrackerMuon())','MMELeadingZMuID')
MMEtri.addSelector('triMMEzzMuIso','PATMuMuEleTriSelector','((leg1.leg1.isolationR03.emEt-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.isolationR03.hadEt-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.isolationR03.emEt-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.isolationR03.hadEt-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMELeadingZMuIso')
...
EEMtri.addDiCandidateModule('triEEMzzCands','PATEleEleMuTriProducer','triEEMosDiElectrons','smearedMuons','smearedMET','smearedJets',1,9999,text='EEMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEMtri.addSelector('triEEMzzEleIso','PATEleEleMuTriSelector','((leg1.leg1.dr03EcalRecHitSumEt-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.dr03HcalTowerSumEt-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.dr03EcalRecHitSumEt-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.dr03HcalTowerSumEt-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','triEEMLeadingZEleIso')
EEMtri.addSelector('triEEMthirdMuID','PATEleEleMuTriSelector','leg2.pt()>5&&leg2.userFloat("SIP3D")<4','EEMthirdMuID')
...
EEEtri.addDiCandidateModule('triEEEzzCands','PATEleEleEleTriProducer','triEEEosDiElectrons','smearedElectrons','smearedMET','smearedJets',1,9999,text='EEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEEtri.addSelector('triEEEzzEleIso','PATEleEleEleTriSelector','((leg1.leg1.dr03EcalRecHitSumEt-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.dr03HcalTowerSumEt-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.dr03EcalRecHitSumEt-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.dr03HcalTowerSumEt-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','triEEELeadingZEleIso')
...
MMEEantiIso1.addDiCandidateModule('antiIso1MMEEeleEle','PATElePairProducer','smearedElectrons','smearedElectrons','smearedMET','smearedJets',1,9999,text='antiIso1MMEEAtLeastOneEleEle',leadingObjectsOnly = False,dR = 0.3,recoMode ="",genParticles='genDaughters')
MMEEantiIso1.addDiCandidateModule('antiIso1MMEEzzCands','PATMuMuEleEleQuadProducer','antiIso1MMEEosDiMuons','antiIso1MMEEeleEle','smearedMET','smearedJets',1,9999,text='antiIso1MMEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMEEantiIso1.addSelector('antiIso1MMEEzzMuIso','PATMuMuEleEleQuadSelector','((leg1.leg1.isolationR03.emEt-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.isolationR03.hadEt-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.isolationR03.emEt-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.isolationR03.hadEt-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso1MMEELeadingZMuIso')
...
MMEEnoIsoSS.addDiCandidateModule('noIsoSSMMEEeleEle','PATElePairProducer','smearedElectrons','smearedElectrons','smearedMET','smearedJets',1,9999,text='noIsoSSMMEEAtLeastOneEleEle',leadingObjectsOnly = False,dR = 0.3,recoMode ="",genParticles='genDaughters')
MMEEnoIsoSS.addDiCandidateModule('noIsoSSMMEEzzCands','PATMuMuEleEleQuadProducer','noIsoSSMMEEosDiMuons','noIsoSSMMEEeleEle','smearedMET','smearedJets',1,9999,text='noIsoSSMMEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMEEnoIsoSS.addSelector('noIsoSSMMEEzzMuIso','PATMuMuEleEleQuadSelector','((leg1.leg1.isolationR03.emEt-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.isolationR03.hadEt-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.isolationR03.emEt-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.isolationR03.hadEt-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','noIsoSSMMEELeadingZMuIso')
...
MMEEantiIso2.addDiCandidateModule('antiIso2MMEEeleEle','PATElePairProducer','smearedElectrons','smearedElectrons','smearedMET','smearedJets',1,9999,text='antiIso2MMEEAtLeastOneEleEle',leadingObjectsOnly = False,dR = 0.3,recoMode ="",genParticles='genDaughters')
MMEEantiIso2.addDiCandidateModule('antiIso2MMEEzzCands','PATMuMuEleEleQuadProducer','antiIso2MMEEosDiMuons','antiIso2MMEEeleEle','smearedMET','smearedJets',1,9999,text='antiIso2MMEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMEEantiIso2.addSelector('antiIso2MMEEzzMuIso','PATMuMuEleEleQuadSelector','((leg1.leg1.isolationR03.emEt-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.isolationR03.hadEt-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.isolationR03.emEt-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.isolationR03.hadEt-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso2MMEELeadingZMuIso')
...
MMEEantiIsoBoth.addDiCandidateModule('antiIsoBothMMEEeleEle','PATElePairProducer','smearedElectrons','smearedElectrons','smearedMET','smearedJets',1,9999,text='antiIsoBothMMEEAtLeastOneEleEle',leadingObjectsOnly = False,dR = 0.3,recoMode ="",genParticles='genDaughters')
MMEEantiIsoBoth.addDiCandidateModule('antiIsoBothMMEEzzCands','PATMuMuEleEleQuadProducer','antiIsoBothMMEEosDiMuons','antiIsoBothMMEEeleEle','smearedMET','smearedJets',1,9999,text='antiIsoBothMMEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMMMantiIso1.addSelector('antiIso1MMMMosDiMuons','PATMuPairSelector','charge==0&&(leg1.isGlobalMuon()||leg1.isTrackerMuon())&&(leg2.isGlobalMuon()||leg2.isTrackerMuon())&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','antiIso1MMMM DiMuonCreation',1)
MMMMantiIso1.addDiCandidateModule('antiIso1MMMMzzCands','PATMuMuMuMuQuadProducer','antiIso1MMMMosDiMuons','antiIso1MMMMdiMuons','smearedMET','smearedJets',1,9999,text='antiIso1MMMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMMMantiIso1.addSelector('antiIso1MMMMzzCleanedMuID','PATMuMuMuMuQuadSelector','(leg1.leg1.isGlobalMuon()||leg1.leg1.isTrackerMuon())&&(leg1.leg2.isGlobalMuon()||leg1.leg2.isTrackerMuon())','antiIso1MMMMLeadingZMuID')
...
MMMMantiIso1.addSelector('MMMMnoIsoOSF','PATMuMuMuMuQuadSelector','(leg2.leg1.isGlobalMuon()||leg2.leg1.isTrackerMuon())&&(leg2.leg2.isGlobalMuon()||leg2.leg2.isTrackerMuon())','antiIso1MMMMsecondPairID')
...
MMMMnoIsoSS.addSelector('noIsoSSMMMMosDiMuons','PATMuPairSelector','charge==0&&(leg1.isGlobalMuon()||leg1.isTrackerMuon())&&(leg2.isGlobalMuon()||leg2.isTrackerMuon())&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','noIsoSSMMMM DiMuonCreation',1)
MMMMnoIsoSS.addDiCandidateModule('noIsoSSMMMMzzCands','PATMuMuMuMuQuadProducer','noIsoSSMMMMosDiMuons','noIsoSSMMMMdiMuons','smearedMET','smearedJets',1,9999,text='noIsoSSMMMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMMMnoIsoSS.addSelector('noIsoSSMMMMzzCleanedMuID','PATMuMuMuMuQuadSelector','(leg1.leg1.isGlobalMuon()||leg1.leg1.isTrackerMuon())&&(leg1.leg2.isGlobalMuon()||leg1.leg2.isTrackerMuon())','noIsoSSMMMMLeadingZMuID')
...
#temp testing
MMMMnoIsoSS.addSelector('MMMMnoIsoSSF','PATMuMuMuMuQuadSelector','(leg2.leg1.isGlobalMuon()||leg2.leg1.isTrackerMuon())&&(leg2.leg2.isGlobalMuon()||leg2.leg2.isTrackerMuon())','noIsoSSMMMMsecondPairID')
...
MMMMnoIsoSS2.addSelector('noIsoSS2MMMMosDiMuons','PATMuPairSelector','charge==0&&(leg1.isGlobalMuon()||leg1.isTrackerMuon())&&(leg2.isGlobalMuon()||leg2.isTrackerMuon())&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','noIsoSS2MMMM DiMuonCreation',1)
...
MMMMantiIso2.addSelector('antiIso2MMMMosDiMuons','PATMuPairSelector','charge==0&&(leg1.isGlobalMuon()||leg1.isTrackerMuon())&&(leg2.isGlobalMuon()||leg2.isTrackerMuon())&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','antiIso2MMMM DiMuonCreation',1)
MMMMantiIso2.addDiCandidateModule('antiIso2MMMMzzCands','PATMuMuMuMuQuadProducer','antiIso2MMMMosDiMuons','antiIso2MMMMdiMuons','smearedMET','smearedJets',1,9999,text='antiIso2MMMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMMMantiIso2.addSelector('antiIso2MMMMzzMuIso','PATMuMuMuMuQuadSelector','((leg1.leg1.isolationR03.emEt-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.isolationR03.hadEt-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.isolationR03.emEt-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.isolationR03.hadEt-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso2MMMMLeadingZMuIso')
MMMMantiIso2.addSelector('antiIso2MMMMnoIsoF','PATMuMuMuMuQuadSelector','(leg2.leg1.isGlobalMuon()||leg2.leg1.isTrackerMuon())&&(leg2.leg2.isGlobalMuon()||leg2.leg2.isTrackerMuon())','antiIso2MMMMsecondPairID')
...
MMMMantiIsoBoth.addSelector('antiIsoBothMMMMosDiMuons','PATMuPairSelector','charge==0&&(leg1.isGlobalMuon()||leg1.isTrackerMuon())&&(leg2.isGlobalMuon()||leg2.isTrackerMuon())&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','antiIsoBothMMMM DiMuonCreation',1)
MMMMantiIsoBoth.addDiCandidateModule('antiIsoBothMMMMzzCands','PATMuMuMuMuQuadProducer','antiIsoBothMMMMosDiMuons','antiIsoBothMMMMdiMuons','smearedMET','smearedJets',1,9999,text='antiIsoBothMMMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMMMantiIsoBoth.addSelector('antiIsoBothMMMMnoIsoF','PATMuMuMuMuQuadSelector','(leg2.leg1.isGlobalMuon()||leg2.leg1.isTrackerMuon())&&(leg2.leg2.isGlobalMuon()||leg2.leg2.isTrackerMuon())','antiIsoBothMMMMsecondPairID')
...
EEEEantiIso1.addDiCandidateModule('antiIso1EEEEzzCands','PATEleEleEleEleQuadProducer','antiIso1EEEEosDiElectrons','antiIso1EEEEdiElectrons','smearedMET','smearedJets',1,9999,text='antiIso1EEEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEEEantiIso1.addSelector('antiIso1EEEEzzEleIso','PATEleEleEleEleQuadSelector','((leg1.leg1.dr03EcalRecHitSumEt-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.dr03HcalTowerSumEt-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.dr03EcalRecHitSumEt-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.dr03HcalTowerSumEt-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso1EEEELeadingZEleIso')
...
EEEEnoIsoSS.addDiCandidateModule('noIsoSSEEEEzzCands','PATEleEleEleEleQuadProducer','noIsoSSEEEEosDiElectrons','noIsoSSEEEEdiElectrons','smearedMET','smearedJets',1,9999,text='noIsoSSEEEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEEEnoIsoSS.addSelector('noIsoSSEEEEzzEleIso','PATEleEleEleEleQuadSelector','((leg1.leg1.dr03EcalRecHitSumEt-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.dr03HcalTowerSumEt-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.dr03EcalRecHitSumEt-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.dr03HcalTowerSumEt-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','noIsoSSEEEELeadingZEleIso')
...
EEEEantiIsoBoth.addDiCandidateModule('antiIsoBothEEEEzzCands','PATEleEleEleEleQuadProducer','antiIsoBothEEEEosDiElectrons','antiIsoBothEEEEdiElectrons','smearedMET','smearedJets',1,9999,text='antiIsoBothEEEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEMMantiIso1.addDiCandidateModule('antiIso1EEMMzzCands','PATEleEleMuMuQuadProducer','antiIso1EEMMosDiElectrons','antiIso1EEMMdiMuons','smearedMET','smearedJets',1,9999,text='antiIso1EEMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEMMantiIso1.addSelector('antiIso1EEMMzzEleIso','PATEleEleMuMuQuadSelector','((leg1.leg1.dr03EcalRecHitSumEt-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.dr03HcalTowerSumEt-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.dr03EcalRecHitSumEt-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.dr03HcalTowerSumEt-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso1EEMMLeadingZEleIso')
...
EEMMantiIso1.addSelector('EEMMnoIsoOSF','PATEleEleMuMuQuadSelector','(leg2.leg1.isGlobalMuon()||leg2.leg1.isTrackerMuon())&&(leg2.leg2.isGlobalMuon()||leg2.leg2.isTrackerMuon())','antiIso1EEMMsecondPairID')
...
EEMMnoIsoSS.addDiCandidateModule('noIsoSSEEMMzzCands','PATEleEleMuMuQuadProducer','noIsoSSEEMMosDiElectrons','noIsoSSEEMMdiMuons','smearedMET','smearedJets',1,9999,text='noIsoSSEEMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEMMnoIsoSS.addSelector('EEMMnoIsoSSF','PATEleEleMuMuQuadSelector','(leg2.leg1.isGlobalMuon()||leg2.leg1.isTrackerMuon())&&(leg2.leg2.isGlobalMuon()||leg2.leg2.isTrackerMuon())&&leg2.mass()>60&&leg2.mass()<120','noIsoSSEEMMsecondPairID')
...
EEMMantiIso2.addDiCandidateModule('antiIso2EEMMzzCands','PATEleEleMuMuQuadProducer','antiIso2EEMMosDiElectrons','antiIso2EEMMdiMuons','smearedMET','smearedJets',1,9999,text='antiIso2EEMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEMMantiIso2.addSelector('antiIso2EEMMzzEleIso','PATEleEleMuMuQuadSelector','((leg1.leg1.dr03EcalRecHitSumEt-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.dr03HcalTowerSumEt-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.dr03EcalRecHitSumEt-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.dr03HcalTowerSumEt-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso2EEMMLeadingZEleIso')
EEMMantiIso2.addSelector('antiIso2EEMMzzMuIDSecondPair','PATEleEleMuMuQuadSelector','(leg2.leg1.isGlobalMuon()||leg2.leg1.isTrackerMuon())&&(leg2.leg2.isGlobalMuon()||leg2.leg2.isTrackerMuon())','antiIso2EEMMsecondPairID')
...
EEMMantiIsoBoth.addDiCandidateModule('antiIsoBothEEMMzzCands','PATEleEleMuMuQuadProducer','antiIsoBothEEMMosDiElectrons','antiIsoBothEEMMdiMuons','smearedMET','smearedJets',1,9999,text='antiIsoBothEEMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEMMantiIsoBoth.addSelector('antiIsoBothEEMMzzEleIso','PATEleEleMuMuQuadSelector','((leg1.leg1.dr03EcalRecHitSumEt-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.dr03HcalTowerSumEt-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.dr03EcalRecHitSumEt-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.dr03HcalTowerSumEt-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIsoBothEEMMLeadingZEleIso')
EEMMantiIsoBoth.addSelector('antiIsoBothEEMMzzMuIDSecondPair','PATEleEleMuMuQuadSelector','(leg2.leg1.isGlobalMuon()||leg2.leg1.isTrackerMuon())&&(leg2.leg2.isGlobalMuon()||leg2.leg2.isTrackerMuon())','antiIsoBothEEMMsecondPairID')
...
MMEEanalysisConfigurator.addDiCandidateModule('MMEEeleEle','PATElePairProducer','smearedElectronsMMEE','smearedElectronsMMEE','smearedMETMMEE','smearedJetsMMEE',1,9999,text='MMEEAtLeastOneEleEle',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
MMEEanalysisConfigurator.addDiCandidateModule('MMEEzzCands','PATMuMuEleEleQuadProducer','MMEEosDiMuons','MMEEeleEle','smearedMETMMEE','smearedJetsMMEE',1,9999,text='MMEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMMManalysisConfigurator.addDiCandidateModule('MMMMzzCands','PATMuMuMuMuQuadProducer','MMMMosDiMuons','MMMMdiMuons','smearedMETMMMM','smearedJetsMMMM',1,9999,text='MMMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMMManalysisConfigurator.addSelector('MMMMzzMuIso','PATMuMuMuMuQuadSelector','((leg1.leg1.isolationR03.emEt-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.isolationR03.hadEt-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.isolationR03.emEt-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.isolationR03.hadEt-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMMMLeadingZMuIso')
MMMManalysisConfigurator.addSelector('MMMMzzMuIDSecondPair','PATMuMuMuMuQuadSelector','(leg2.leg1.isGlobalMuon()||leg2.leg1.isTrackerMuon())&&(leg2.leg2.isGlobalMuon()||leg2.leg2.isTrackerMuon())&&leg2.leg1.isTrackerMuon()&&leg2.leg2.isTrackerMuon()','MMMMsecondPairID')
MMMManalysisConfigurator.addSelector('MMMMzzMuIso2','PATMuMuMuMuQuadSelector','((leg2.leg1.isolationR03.emEt-leg2.leg1.userFloat("rho")*(0.087)+leg2.leg1.isolationR03.hadEt-leg2.leg1.userFloat("rho")*(0.059) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.30)','MMMMSecondZMuIso')
...
EEEEanalysisConfigurator.addDiCandidateModule('EEEEzzCands','PATEleEleEleEleQuadProducer','EEEEosDiElectrons','EEEEdiElectrons','smearedMETEEEE','smearedJetsEEEE',1,9999,text='EEEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEEEanalysisConfigurator.addSelector('EEEEzzEleIso','PATEleEleEleEleQuadSelector','((leg1.leg1.dr03EcalRecHitSumEt-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.dr03HcalTowerSumEt-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.dr03EcalRecHitSumEt-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.dr03HcalTowerSumEt-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','EEEELeadingZEleIso')
...
EEEEanalysisConfigurator.addSelector('EEEEzzEleIso2','PATEleEleEleEleQuadSelector','((leg2.leg1.dr03EcalRecHitSumEt-leg2.leg1.userFloat("rho")*(0.101)+leg2.leg1.dr03HcalTowerSumEt-leg2.leg1.userFloat("rho")*(0.072) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','EEEESecondZEleIso')
...
EEMManalysisConfigurator.addDiCandidateModule('EEMMzzCands','PATEleEleMuMuQuadProducer','EEMMosDiElectrons','EEMMdiMuons','smearedMETEEMM','smearedJetsEEMM',1,9999,text='EEMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEMManalysisConfigurator.addSelector('EEMMzzEleIso','PATEleEleMuMuQuadSelector','((leg1.leg1.dr03EcalRecHitSumEt-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.dr03HcalTowerSumEt-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.dr03EcalRecHitSumEt-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.dr03HcalTowerSumEt-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','EEMMLeadingZEleIso')
#EEMManalysisConfigurator.addSelector('EEMMzzMuMuMass','PATEleEleMuMuQuadSelector','leg2.mass<60','EEMMmumuMass')
EEMManalysisConfigurator.addSelector('EEMMzzMuIDSecondPair','PATEleEleMuMuQuadSelector','(leg2.leg1.isGlobalMuon()||leg2.leg1.isTrackerMuon())&&(leg2.leg2.isGlobalMuon()||leg2.leg2.isTrackerMuon())&&leg2.leg1.isTrackerMuon()&&leg2.leg2.isTrackerMuon()','EEMMsecondPairID')
EEMManalysisConfigurator.addSelector('EEMMzzMuIso2','PATEleEleMuMuQuadSelector','((leg2.leg1.isolationR03.emEt-leg2.leg1.userFloat("rho")*(0.087)+leg2.leg1.isolationR03.hadEt-leg2.leg1.userFloat("rho")*(0.059) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','EEMMLeadingZMuIso')
...
MMMTantiIso1.addDiCandidateModule('antiIso1MMMTzzCands','PATMuMuMuTauQuadProducer','antiIso1MMMTosDiMuons','antiIso1MMMTmuTau','smearedMET','smearedJets',1,9999,text='MMMTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMMTantiIso1.addSelector('antiIso1MMMTzzMuID2','PATMuMuMuTauQuadSelector','(leg2.leg1.isGlobalMuon()||leg2.leg1.isTrackerMuon())&&leg2.leg1.isTrackerMuon()','MMMTSecondZMuID')
...
MMMTnoIsoSS.addDiCandidateModule('noIsoSSMMMTzzCands','PATMuMuMuTauQuadProducer','noIsoSSMMMTosDiMuons','noIsoSSMMMTmuTau','smearedMET','smearedJets',1,9999,text='MMMTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMMTnoIsoSS.addSelector('noIsoSSMMMTzzMuID2','PATMuMuMuTauQuadSelector','(leg2.leg1.isGlobalMuon()||leg2.leg1.isTrackerMuon())&&leg2.leg1.isTrackerMuon()','MMMTSecondZMuID')
...
MMMTantiIso2.addDiCandidateModule('antiIso2MMMTzzCands','PATMuMuMuTauQuadProducer','antiIso2MMMTosDiMuons','antiIso2MMMTmuTau','smearedMET','smearedJets',1,9999,text='MMMTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMMTantiIso2.addSelector('antiIso2MMMTzzMuID2','PATMuMuMuTauQuadSelector','(leg2.leg1.isGlobalMuon()||leg2.leg1.isTrackerMuon())&&leg2.leg1.isTrackerMuon()','MMMTSecondZMuID')
...
MMMTantiIsoBoth.addDiCandidateModule('antiIsoBothMMMTzzCands','PATMuMuMuTauQuadProducer','antiIsoBothMMMTosDiMuons','antiIsoBothMMMTmuTau','smearedMET','smearedJets',1,9999,text='MMMTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMMTantiIsoBoth.addSelector('antiIsoBothMMMTzzMuID2','PATMuMuMuTauQuadSelector','(leg2.leg1.isGlobalMuon()||leg2.leg1.isTrackerMuon())&&leg2.leg1.isTrackerMuon()','MMMTSecondZMuID')
...
MMTTantiIso1.addDiCandidateModule('antiIso1MMTTzzCands','PATMuMuTauTauQuadProducer','antiIso1MMTTosDiMuons','antiIso1MMTTdiTaus','smearedMET','smearedJets',1,9999,text='MMTTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMTTnoIsoSS.addDiCandidateModule('noIsoSSMMTTzzCands','PATMuMuTauTauQuadProducer','noIsoSSMMTTosDiMuons','noIsoSSMMTTdiTaus','smearedMET','smearedJets',1,9999,text='MMTTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMTTantiIso2.addDiCandidateModule('antiIso2MMTTzzCands','PATMuMuTauTauQuadProducer','antiIso2MMTTosDiMuons','antiIso2MMTTdiTaus','smearedMET','smearedJets',1,9999,text='MMTTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMTTantiIsoBoth.addDiCandidateModule('antiIsoBothMMTTzzCands','PATMuMuTauTauQuadProducer','antiIsoBothMMTTosDiMuons','antiIsoBothMMTTdiTaus','smearedMET','smearedJets',1,9999,text='MMTTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMETantiIso1.addDiCandidateModule('antiIso1MMETzzCands','PATMuMuEleTauQuadProducer','antiIso1MMETosDiMuons','antiIso1MMETelecTau','smearedMET','smearedJets',1,9999,text='antiIso1MMETAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMETnoIsoSS.addDiCandidateModule('noIsoSSMMETzzCands','PATMuMuEleTauQuadProducer','noIsoSSMMETosDiMuons','noIsoSSMMETelecTau','smearedMET','smearedJets',1,9999,text='noIsoSSMMETAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMETantiIso2.addDiCandidateModule('antiIso2MMETzzCands','PATMuMuEleTauQuadProducer','antiIso2MMETosDiMuons','antiIso2MMETelecTau','smearedMET','smearedJets',1,9999,text='antiIso2MMETAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMETantiIsoBoth.addDiCandidateModule('antiIsoBothMMETzzCands','PATMuMuEleTauQuadProducer','antiIsoBothMMETosDiMuons','antiIsoBothMMETelecTau','smearedMET','smearedJets',1,9999,text='antiIsoBothMMETAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMEMantiIso1.addDiCandidateModule('antiIso1MMEMelecMu','PATEleMuPairProducer','smearedElectrons','smearedMuons','smearedMET','smearedJets',1,9999,text='MMEMAtLeastOneDiTau',leadingObjectsOnly = False,dR = 0.4,recoMode ="",genParticles='genDaughters')
MMEMantiIso1.addDiCandidateModule('antiIso1MMEMzzCands','PATMuMuEleMuQuadProducer','antiIso1MMEMosDiMuons','antiIso1MMEMelecMu','smearedMET','smearedJets',1,9999,text='MMEMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMEMantiIso1.addSelector('antiIso1MMEMzzCleanedThirdMuID','PATMuMuEleMuQuadSelector','(leg2.leg2.isGlobalMuon()||leg2.leg2.isTrackerMuon())&&leg2.leg2.isTrackerMuon()','MMEMThirdMuID')
...
MMEMnoIsoSS.addDiCandidateModule('noIsoSSMMEMelecMu','PATEleMuPairProducer','smearedElectrons','smearedMuons','smearedMET','smearedJets',1,9999,text='MMEMAtLeastOneDiTau',leadingObjectsOnly = False,dR = 0.4,recoMode ="",genParticles='genDaughters')
MMEMnoIsoSS.addDiCandidateModule('noIsoSSMMEMzzCands','PATMuMuEleMuQuadProducer','noIsoSSMMEMosDiMuons','noIsoSSMMEMelecMu','smearedMET','smearedJets',1,9999,text='MMEMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMEMnoIsoSS.addSelector('noIsoSSMMEMzzCleanedThirdMuID','PATMuMuEleMuQuadSelector','(leg2.leg2.isGlobalMuon()||leg2.leg2.isTrackerMuon())&&leg2.leg2.isTrackerMuon()','MMEMThirdMuID')
...
MMEMantiIso2.addDiCandidateModule('antiIso2MMEMelecMu','PATEleMuPairProducer','smearedElectrons','smearedMuons','smearedMET','smearedJets',1,9999,text='MMEMAtLeastOneDiTau',leadingObjectsOnly = False,dR = 0.4,recoMode ="",genParticles='genDaughters')
MMEMantiIso2.addDiCandidateModule('antiIso2MMEMzzCands','PATMuMuEleMuQuadProducer','antiIso2MMEMosDiMuons','antiIso2MMEMelecMu','smearedMET','smearedJets',1,9999,text='MMEMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMEMantiIso2.addSelector('antiIso2MMEMzzCleanedThirdMuID','PATMuMuEleMuQuadSelector','(leg2.leg2.isGlobalMuon()||leg2.leg2.isTrackerMuon())&&leg2.leg2.isTrackerMuon()','MMEMThirdMuID')
...
MMEMantiIsoBoth.addDiCandidateModule('antiIsoBothMMEMelecMu','PATEleMuPairProducer','smearedElectrons','smearedMuons','smearedMET','smearedJets',1,9999,text='MMEMAtLeastOneDiTau',leadingObjectsOnly = False,dR = 0.4,recoMode ="",genParticles='genDaughters')
MMEMantiIsoBoth.addDiCandidateModule('antiIsoBothMMEMzzCands','PATMuMuEleMuQuadProducer','antiIsoBothMMEMosDiMuons','antiIsoBothMMEMelecMu','smearedMET','smearedJets',1,9999,text='MMEMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
MMEMantiIsoBoth.addSelector('antiIsoBothMMEMzzCleanedThirdMuID','PATMuMuEleMuQuadSelector','(leg2.leg2.isGlobalMuon()||leg2.leg2.isTrackerMuon())&&leg2.leg2.isTrackerMuon()','MMEMThirdMuID')
...
EEMTantiIso1.addDiCandidateModule('antiIso1EEMTzzCands','PATEleEleMuTauQuadProducer','antiIso1EEMTosDiElectrons','antiIso1EEMTmuTau','smearedMET','smearedJets',1,9999,text='antiIso1EEMTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEMTantiIso1.addSelector('antiIso1EEMTzzCleanedmuID','PATEleEleMuTauQuadSelector','(leg2.leg1.isGlobalMuon()||leg2.leg1.isTrackerMuon())&&leg2.leg1.isTrackerMuon()','antiIso1EEMTMuID')
...
EEMTnoIsoSS.addDiCandidateModule('noIsoSSEEMTzzCands','PATEleEleMuTauQuadProducer','noIsoSSEEMTosDiElectrons','noIsoSSEEMTmuTau','smearedMET','smearedJets',1,9999,text='noIsoSSEEMTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEMTnoIsoSS.addSelector('noIsoSSEEMTzzCleanedmuID','PATEleEleMuTauQuadSelector','(leg2.leg1.isGlobalMuon()||leg2.leg1.isTrackerMuon())&&leg2.leg1.isTrackerMuon()','noIsoSSEEMTMuID')
...
EEMTantiIso2.addDiCandidateModule('antiIso2EEMTzzCands','PATEleEleMuTauQuadProducer','antiIso2EEMTosDiElectrons','antiIso2EEMTmuTau','smearedMET','smearedJets',1,9999,text='antiIso2EEMTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEMTantiIso2.addSelector('antiIso2EEMTzzCleanedmuID','PATEleEleMuTauQuadSelector','(leg2.leg1.isGlobalMuon()||leg2.leg1.isTrackerMuon())&&leg2.leg1.isTrackerMuon()','antiIso2EEMTMuID')
...
EEMTantiIsoBoth.addDiCandidateModule('antiIsoBothEEMTzzCands','PATEleEleMuTauQuadProducer','antiIsoBothEEMTosDiElectrons','antiIsoBothEEMTmuTau','smearedMET','smearedJets',1,9999,text='antiIsoBothEEMTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEMTantiIsoBoth.addSelector('antiIsoBothEEMTzzCleanedmuID','PATEleEleMuTauQuadSelector','(leg2.leg1.isGlobalMuon()||leg2.leg1.isTrackerMuon())&&leg2.leg1.isTrackerMuon()','antiIsoBothEEMTMuID')
...
EEETantiIso1.addDiCandidateModule('antiIso1EEETzzCands','PATEleEleEleTauQuadProducer','antiIso1EEETosDiElectrons','antiIso1EEETeleTau','smearedMET','smearedJets',1,9999,text='antiIso1EEETAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEETnoIsoSS.addDiCandidateModule('noIsoSSEEETzzCands','PATEleEleEleTauQuadProducer','noIsoSSEEETosDiElectrons','noIsoSSEEETeleTau','smearedMET','smearedJets',1,9999,text='noIsoSSEEETAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEETantiIso2.addDiCandidateModule('antiIso2EEETzzCands','PATEleEleEleTauQuadProducer','antiIso2EEETosDiElectrons','antiIso2EEETeleTau','smearedMET','smearedJets',1,9999,text='antiIso2EEETAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEETantiIsoBoth.addDiCandidateModule('antiIsoBothEEETzzCands','PATEleEleEleTauQuadProducer','antiIsoBothEEETosDiElectrons','antiIsoBothEEETeleTau','smearedMET','smearedJets',1,9999,text='antiIsoBothEEETAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EETTantiIso1.addDiCandidateModule('antiIso1EETTzzCands','PATEleEleTauTauQuadProducer','antiIso1EETTosDiElectrons','antiIso1EETTtauTau','smearedMET','smearedJets',1,9999,text='antiIso1EETTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EETTnoIsoSS.addDiCandidateModule('noIsoSSEETTzzCands','PATEleEleTauTauQuadProducer','noIsoSSEETTosDiElectrons','noIsoSSEETTtauTau','smearedMET','smearedJets',1,9999,text='noIsoSSEETTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EETTantiIso2.addDiCandidateModule('antiIso2EETTzzCands','PATEleEleTauTauQuadProducer','antiIso2EETTosDiElectrons','antiIso2EETTtauTau','smearedMET','smearedJets',1,9999,text='antiIso2EETTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EETTantiIsoBoth.addDiCandidateModule('antiIsoBothEETTzzCands','PATEleEleTauTauQuadProducer','antiIsoBothEETTosDiElectrons','antiIsoBothEETTtauTau','smearedMET','smearedJets',1,9999,text='antiIsoBothEETTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEEMantiIso1.addDiCandidateModule('antiIso1EEEMeleMu','PATEleMuPairProducer', 'smearedElectrons','smearedMuons','smearedMET','smearedJets',1,9999,text = 'antiIso1EEEMAtLeastOneMuTau',leadingObjectsOnly = False,dR = 0.4,recoMode = "",genParticles='genDaughters')
EEEMantiIso1.addDiCandidateModule('antiIso1EEEMzzCands','PATEleEleEleMuQuadProducer','antiIso1EEEMosDiElectrons','antiIso1EEEMeleMu','smearedMET','smearedJets',1,9999,text='antiIso1EEEMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEEMantiIso1.addSelector('EEEMnoIsoOSF','PATEleEleEleMuQuadSelector','(leg2.leg2.isGlobalMuon()||leg2.leg2.isTrackerMuon())&&leg2.leg2.isTrackerMuon()','antiIso1EEEMMuID')
...
EEEMnoIsoSS.addDiCandidateModule('noIsoSSEEEMeleMu','PATEleMuPairProducer', 'smearedElectrons','smearedMuons','smearedMET','smearedJets',1,9999,text = 'noIsoSSEEEMAtLeastOneMuTau',leadingObjectsOnly = False,dR = 0.4,recoMode = "",genParticles='genDaughters')
EEEMnoIsoSS.addDiCandidateModule('noIsoSSEEEMzzCands','PATEleEleEleMuQuadProducer','noIsoSSEEEMosDiElectrons','noIsoSSEEEMeleMu','smearedMET','smearedJets',1,9999,text='noIsoSSEEEMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEEMnoIsoSS.addSelector('EEEMnoIsoSSF','PATEleEleEleMuQuadSelector','(leg2.leg2.isGlobalMuon()||leg2.leg2.isTrackerMuon())&&leg2.leg2.isTrackerMuon()','noIsoSSEEEMMuID')
...
EEEMantiIso2.addDiCandidateModule('antiIso2EEEMeleMu','PATEleMuPairProducer', 'smearedElectrons','smearedMuons','smearedMET','smearedJets',1,9999,text = 'antiIso2EEEMAtLeastOneMuTau',leadingObjectsOnly = False,dR = 0.4,recoMode = "",genParticles='genDaughters')
EEEMantiIso2.addDiCandidateModule('antiIso2EEEMzzCands','PATEleEleEleMuQuadProducer','antiIso2EEEMosDiElectrons','antiIso2EEEMeleMu','smearedMET','smearedJets',1,9999,text='antiIso2EEEMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEEMantiIso2.addSelector('antiIso2EEEMzzMuID','PATEleEleEleMuQuadSelector','(leg2.leg2.isGlobalMuon()||leg2.leg2.isTrackerMuon())&&leg2.leg2.isTrackerMuon()','antiIso2EEEMMuID')
...
EEEMantiIsoBoth.addDiCandidateModule('antiIsoBothEEEMeleMu','PATEleMuPairProducer', 'smearedElectrons','smearedMuons','smearedMET','smearedJets',1,9999,text = 'antiIsoBothEEEMAtLeastOneMuTau',leadingObjectsOnly = False,dR = 0.4,recoMode = "",genParticles='genDaughters')
EEEMantiIsoBoth.addDiCandidateModule('antiIsoBothEEEMzzCands','PATEleEleEleMuQuadProducer','antiIsoBothEEEMosDiElectrons','antiIsoBothEEEMeleMu','smearedMET','smearedJets',1,9999,text='antiIsoBothEEEMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.005,recoMode ="",genParticles='genDaughters')
...
EEEMantiIsoBoth.addSelector('antiIsoBothEEEMzzMuID','PATEleEleEleMuQuadSelector','(leg2.leg2.isGlobalMuon()||leg2.leg2.isTrackerMuon())&&leg2.leg2.isTrackerMuon()','antiIsoBothEEEMMuID')
