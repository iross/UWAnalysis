...
MMMTantiIso2.addSelector('antiIso2MMMTzzMuIso','PATMuMuMuTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMMTLeadingZMuIso')
...
MMMTantiIso2.addSelector('MMMTantiIso2F','PATMuMuMuTauQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.074 : 0.045)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.022 : 0.030) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','MMMTSecondZMuIso')
#create the sequence
...
MMTTantiIso1.addSelector('antiIso1MMTTzzMuIso','PATMuMuTauTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMTTLeadingZMuIso')
...
MMTTnoIsoSS.addSelector('noIsoSSMMTTzzMuIso','PATMuMuTauTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMTTLeadingZMuIso')
...
MMTTantiIso2.addSelector('antiIso2MMTTzzMuIso','PATMuMuTauTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMTTLeadingZMuIso')
...
MMETantiIso1.addSelector('antiIso1MMETzzMuIso','PATMuMuEleTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso1MMETLeadingZMuIso')
...
MMETnoIsoSS.addSelector('noIsoSSMMETzzMuIso','PATMuMuEleTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','noIsoSSMMETLeadingZMuIso')
...
MMETantiIso2.addSelector('antiIso2MMETzzMuIso','PATMuMuEleTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso2MMETLeadingZMuIso')
...
MMETantiIso2.addSelector('MMETantiIso2F','PATMuMuEleTauQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.074 : 0.045)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.022 : 0.030) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','MMEMEleIso')
...
MMETantiIsoBoth.addSelector('antiIsoBothMMETzzMuIso','PATMuMuEleTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIsoBothMMETLeadingZMuIso')
...
MMEMantiIso1.addSelector('antiIso1MMEMzzMuIso','PATMuMuEleMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMEMLeadingZMuIso')
...
MMEMantiIso1.addSelector('MMEMantiIso1F','PATMuMuEleMuQuadSelector','((leg2.leg2.userIso(1)-leg2.leg2.userFloat("rho")*(? abs(leg2.leg2.eta())<1.479 ? 0.074 : 0.045)+leg2.leg2.userIso(2)-leg2.leg2.userFloat("rho")*(? abs(leg2.leg2.eta())<1.479 ? 0.022 : 0.030) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.20)','MMEMMuIso')
...
MMEMnoIsoSS.addSelector('noIsoSSMMEMzzMuIso','PATMuMuEleMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMEMLeadingZMuIso')
...
MMEMantiIso2.addSelector('MMEMantiIso2F','PATMuMuEleMuQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.074 : 0.045)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.022 : 0.030) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','MMEMMuIso')
...
MMEMantiIsoBoth.addSelector('antiIsoBothMMEMzzMuIso','PATMuMuEleMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMEMLeadingZMuIso')
...
MMEEantiIso1.addSelector('antiIso1MMEEzzMuIso','PATMuMuEleEleQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso1MMEELeadingZMuIso')
...
MMEEantiIso1.addSelector('MMEEantiIso1F','PATMuMuEleEleQuadSelector','((leg2.leg2.userIso(1)-leg2.leg2.userFloat("rho")*(? abs(leg2.leg2.eta())<1.479 ? 0.074 : 0.045)+leg2.leg2.userIso(2)-leg2.leg2.userFloat("rho")*(? abs(leg2.leg2.eta())<1.479 ? 0.022 : 0.030) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.20)','antiIso1MMEEZEleIso')
...
MMEEnoIsoSS.addSelector('noIsoSSMMEEzzMuIso','PATMuMuEleEleQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','noIsoSSMMEELeadingZMuIso')
...
MMEEantiIso2.addSelector('antiIso2MMEEzzMuIso','PATMuMuEleEleQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso2MMEELeadingZMuIso')
...
MMEEantiIso2.addSelector('MMEEantiIso2F','PATMuMuEleEleQuadSelector','((leg2.leg2.userIso(1)-leg2.leg2.userFloat("rho")*(? abs(leg2.leg2.eta())<1.479 ? 0.074 : 0.045)+leg2.leg2.userIso(2)-leg2.leg2.userFloat("rho")*(? abs(leg2.leg2.eta())<1.479 ? 0.022 : 0.030) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.20)','antiIso2MMEEZEleIso')
...
MMEEantiIsoBoth.addSelector('antiIsoBothMMEEzzMuIso','PATMuMuEleEleQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIsoBothMMEELeadingZMuIso')
...
MMMMantiIso1.addSelector('antiIso1MMMMzzMuIso','PATMuMuMuMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso1MMMMLeadingZMuIso')
...
MMMMantiIso1.addSelector('MMMMantiIso1F','PATMuMuMuMuQuadSelector','((leg2.leg2.userIso(1)-leg2.leg2.userFloat("rho")*(? abs(leg2.leg2.eta())<1.479 ? 0.074 : 0.045)+leg2.leg2.userIso(2)-leg2.leg2.userFloat("rho")*(? abs(leg2.leg2.eta())<1.479 ? 0.022 : 0.030) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.20)','antiIso1MMMMSecondZMuIso')
...
MMMMnoIsoSS.addSelector('noIsoSSMMMMzzMuIso','PATMuMuMuMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','noIsoSSMMMMLeadingZMuIso')
...
MMMMantiIso2.addSelector('antiIso2MMMMzzMuIso','PATMuMuMuMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso2MMMMLeadingZMuIso')
...
MMMMantiIso2.addSelector('MMMMantiIso2F','PATMuMuMuMuQuadSelector','((leg2.leg2.userIso(1)-leg2.leg2.userFloat("rho")*(? abs(leg2.leg2.eta())<1.479 ? 0.074 : 0.045)+leg2.leg2.userIso(2)-leg2.leg2.userFloat("rho")*(? abs(leg2.leg2.eta())<1.479 ? 0.022 : 0.030) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.20)','antiIsoMMMMSecondZMuIso')
...
MMMMantiIsoBoth.addSelector('antiIsoBothMMMMzzMuIso','PATMuMuMuMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIsoBothMMMMLeadingZMuIso')
...
EEMTantiIso1.addSelector('antiIso1EEMTzzEleIso','PATEleEleMuTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso1EEMTLeadingZEleIso')
...
EEMTnoIsoSS.addSelector('noIsoSSEEMTzzEleIso','PATEleEleMuTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','noIsoSSEEMTLeadingZEleIso')
...
EEMTantiIso2.addSelector('antiIso2EEMTzzEleIso','PATEleEleMuTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso2EEMTLeadingZEleIso')
...
EEMTantiIso2.addSelector('EEMTantiIso2F','PATEleEleMuTauQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.074 : 0.045)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.022 : 0.030) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','antiIsoEEMTSecondZMuIso')
...
EEMTantiIsoBoth.addSelector('antiIsoBothEEMTzzEleIso','PATEleEleMuTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIsoBothEEMTLeadingZEleIso')
...
EEETantiIso1.addSelector('antiIso1EEETzzEleIso','PATEleEleEleTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso1EEETLeadingZEleIso')
...
EEETnoIsoSS.addSelector('noIsoSSEEETzzEleIso','PATEleEleEleTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','noIsoSSEEETLeadingZEleIso')
...
EEETantiIso2.addSelector('antiIso2EEETzzEleIso','PATEleEleEleTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso2EEETLeadingZEleIso')
...
EEETantiIso2.addSelector('EEETantiIso2F','PATEleEleEleTauQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.074 : 0.045)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.022 : 0.030) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','antiIsoEEETSecondZEleIso')
...
EEETantiIsoBoth.addSelector('antiIsoBothEEETzzEleIso','PATEleEleEleTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIsoBothEEETLeadingZEleIso')
...
EETTantiIso1.addSelector('antiIso1EETTzzEleIso','PATEleEleTauTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso1EETTLeadingZEleIso')
...
EETTnoIsoSS.addSelector('noIsoSSEETTzzEleIso','PATEleEleTauTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','noIsoSSEETTLeadingZEleIso')
...
EETTantiIso2.addSelector('antiIso2EETTzzEleIso','PATEleEleTauTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso2EETTLeadingZEleIso')
...
EETTantiIsoBoth.addSelector('antiIsoBothEETTzzEleIso','PATEleEleTauTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIsoBothEETTLeadingZEleIso')
...
EEEMantiIso1.addSelector('antiIso1EEEMzzEleIso','PATEleEleEleMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso1EEEMLeadingZEleIso')
...
EEEMantiIso1.addSelector('EEEMantiIso1F','PATEleEleEleMuQuadSelector','((leg2.leg2.userIso(1)-leg2.leg2.userFloat("rho")*(? abs(leg2.leg2.eta())<1.479 ? 0.074 : 0.045)+leg2.leg2.userIso(2)-leg2.leg2.userFloat("rho")*(? abs(leg2.leg2.eta())<1.479 ? 0.022 : 0.030) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.20)','antiIso1EEEMSecondZMuIso')
...
EEEMnoIsoSS.addSelector('noIsoSSEEEMzzEleIso','PATEleEleEleMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','noIsoSSEEEMLeadingZEleIso')
...
EEEMantiIso2.addSelector('antiIso2EEEMzzEleIso','PATEleEleEleMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso2EEEMLeadingZEleIso')
...
EEEMantiIso2.addSelector('EEEMantiIso2F','PATEleEleEleMuQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.074 : 0.045)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.022 : 0.030) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','antiIsoEEEMSecondZEleIso')
...
EEEMantiIsoBoth.addSelector('antiIsoBothEEEMzzEleIso','PATEleEleEleMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIsoBothEEEMLeadingZEleIso')
...
EEEEantiIso1.addSelector('antiIso1EEEEzzEleIso','PATEleEleEleEleQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso1EEEELeadingZEleIso')
...
EEEEantiIso1.addSelector('EEEEantiIso1F','PATEleEleEleEleQuadSelector','((leg2.leg2.userIso(1)-leg2.leg2.userFloat("rho")*(? abs(leg2.leg2.eta())<1.479 ? 0.074 : 0.045)+leg2.leg2.userIso(2)-leg2.leg2.userFloat("rho")*(? abs(leg2.leg2.eta())<1.479 ? 0.022 : 0.030) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.20)','antiIso1EEEESecondZEleIso')
...
EEEEnoIsoSS.addSelector('noIsoSSEEEEzzEleIso','PATEleEleEleEleQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','noIsoSSEEEELeadingZEleIso')
...
EEEEantiIso2.addSelector('antiIso2EEEEzzEleIso','PATEleEleEleEleQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso2EEEELeadingZEleIso')
...
EEEEantiIso2.addSelector('EEEEantiIso2F','PATEleEleEleEleQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.074 : 0.045)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.022 : 0.030) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','antiIsoEEEESecondZEleIso')
...
EEEEantiIsoBoth.addSelector('antiIsoBothEEEEzzEleIso','PATEleEleEleEleQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIsoBothEEEELeadingZEleIso')
...
EEMMantiIso1.addSelector('antiIso1EEMMzzEleIso','PATEleEleMuMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso1EEMMLeadingZEleIso')
...
EEMMantiIso1.addSelector('EEMMantiIso1F','PATEleEleMuMuQuadSelector','((leg2.leg2.userIso(1)-leg2.leg2.userFloat("rho")*(? abs(leg2.leg2.eta())<1.479 ? 0.074 : 0.045)+leg2.leg2.userIso(2)-leg2.leg2.userFloat("rho")*(? abs(leg2.leg2.eta())<1.479 ? 0.022 : 0.030) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.20)','antiIso1EEMMLeadingZMuIso')
...
EEMMnoIsoSS.addSelector('noIsoSSEEMMzzEleIso','PATEleEleMuMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','noIsoSSEEMMLeadingZEleIso')
...
EEMMantiIso2.addSelector('antiIso2EEMMzzEleIso','PATEleEleMuMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso2EEMMLeadingZEleIso')
...
EEMMantiIso2.addSelector('EEMMantiIso2F','PATEleEleMuMuQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.074 : 0.045)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.022 : 0.030) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','antiIsoEEMMLeadingZMuIso')
...
EEMMantiIsoBoth.addSelector('antiIsoBothEEMMzzEleIso','PATEleEleMuMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIsoBothEEMMLeadingZEleIso')
...
MMEEanalysisConfigurator.addSelector('MMEEzzMuIso','PATMuMuEleEleQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMEELeadingZMuIso')
...
MMEEanalysisConfigurator.addSelector('MMEEzzEleIso','PATMuMuEleEleQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.074 : 0.045)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.022 : 0.030) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','MMEEZEleIso')
...
MMMManalysisConfigurator.addSelector('MMMMzzMuIso','PATMuMuMuMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMMMLeadingZMuIso')
...
MMMManalysisConfigurator.addSelector('MMMMzzMuIso2','PATMuMuMuMuQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.074 : 0.045)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.022 : 0.030) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.30)','MMMMSecondZMuIso')
...
EEEEanalysisConfigurator.addSelector('EEEEzzEleIso','PATEleEleEleEleQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','EEEELeadingZEleIso')
...
EEEEanalysisConfigurator.addSelector('EEEEzzEleIso2','PATEleEleEleEleQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.074 : 0.045)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.022 : 0.030) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','EEEESecondZEleIso')
...
EEMManalysisConfigurator.addSelector('EEMMzzEleIso','PATEleEleMuMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.074 : 0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(? abs(leg1.leg1.eta())<1.479 ? 0.022 : 0.030) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.074 : 0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(? abs(leg1.leg2.eta())<1.479 ? 0.022 : 0.030) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','EEMMLeadingZEleIso')
...
EEMManalysisConfigurator.addSelector('EEMMzzMuIso2','PATEleEleMuMuQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.074 : 0.045)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(? abs(leg2.leg1.eta())<1.479 ? 0.022 : 0.030) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','EEMMLeadingZMuIso')
