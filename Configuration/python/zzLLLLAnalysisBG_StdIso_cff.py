...
MMMtri = CutSequenceProducer(initialCounter  = 'initialEventsMMM',
                                  ...
                                  pyNameSpace  = locals())
#MMMtri.addSmearing('patOverloadedTaus','patMuonsForAnalysis','convRejElectrons','selectedPatJets')
MMMtri.addDiCandidateModule('triMMMdiMuons','PATMuPairProducer', 'smearedMuons','smearedMuons','smearedMET','smearedJets',1,genParticles='genDaughters')
MMMtri.addSelector('triMMMosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50 && mass < 120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','MMMDiMuonCreation',1)
MMMtri.addDiCandidateModule('triMMMzzCands','PATMuMuMuTriProducer','triMMMosDiMuons','smearedMuons','smearedMET','smearedJets',1,9999,text='MMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMMtri.addSelector('triMMMzzMuID','PATMuMuMuTriSelector','leg1.leg1.isGlobalMuon()&&leg1.leg1.isTrackerMuon()&&leg1.leg2.isTrackerMuon()&&leg1.leg2.isTrackerMuon()','MMMLeadingZMuID')
MMMtri.addSelector('triMMMzzMuIso','PATMuMuMuTriSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMMLeadingZMuIso')
MMMtri.addSelector('triMMMthirdMuID','PATMuMuMuTriSelector','leg2.pt()>5&&leg2.isGlobalMuon()&&leg2.userFloat("SIP3D")<4','MMMthirdMuID')
#MMMtri.addSelector('triMMMthirdMuID','PATMuMuMuTriSelector','leg2.pt()>5&&leg2.userFloat("SIP3D")<4','MMMthirdMuID')
...
MMEtri = CutSequenceProducer(initialCounter  = 'initialEventsMME',
                                  pyModuleName = __name__,
                                  pyNameSpace  = locals())
#MMEtri.addSmearing('patOverloadedTaus','patMuonsForAnalysis','convRejElectrons','selectedPatJets')
MMEtri.addDiCandidateModule('triMMEdiMuons','PATMuPairProducer', 'smearedMuons','smearedMuons','smearedMET','smearedJets',1,genParticles='genDaughters')
MMEtri.addSelector('triMMEosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50 && mass < 120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','MMEDiMuonCreation',1)
MMEtri.addDiCandidateModule('triMMEzzCands','PATMuMuEleTriProducer','triMMEosDiMuons','smearedElectrons','smearedMET','smearedJets',1,9999,text='MMEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMEtri.addSelector('triMMEzzMuID','PATMuMuEleTriSelector','leg1.leg1.isGlobalMuon()&&leg1.leg1.isTrackerMuon()&&leg1.leg2.isTrackerMuon()&&leg1.leg2.isTrackerMuon()','MMELeadingZMuID')
MMEtri.addSelector('triMMEzzMuIso','PATMuMuEleTriSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMELeadingZMuIso')
MMEtri.addSelector('triMMEthirdEleID','PATMuMuEleTriSelector','leg2.pt()>7&&leg2.userFloat("SIP3D")<4','MMEthirdEleID')
...
EEMtri = CutSequenceProducer(initialCounter  = 'initialEventsEEM',
                                  pyModuleName = __name__,
                                  pyNameSpace  = locals())
EEMtri.addDiCandidateModule('triEEMdiElectrons','PATElePairProducer', 'smearedElectrons','smearedElectrons','smearedMET','smearedJets',1,genParticles='genDaughters')
EEMtri.addSelector('triEEMosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','triEEMDiEleCreation',1)
EEMtri.addDiCandidateModule('triEEMzzCands','PATEleEleMuTriProducer','triEEMosDiElectrons','smearedMuons','smearedMET','smearedJets',1,9999,text='EEMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEMtri.addSelector('triEEMzzEleIso','PATEleEleMuTriSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','triEEMLeadingZEleIso')
EEMtri.addSelector('triEEMthirdMuID','PATEleEleMuTriSelector','leg2.pt()>5&&leg2.isGlobalMuon()&&leg2.userFloat("SIP3D")<4','EEMthirdMuID')
...
EEEtri = CutSequenceProducer(initialCounter  = 'initialEventsEEE',
                                  pyModuleName = __name__,
                                  pyNameSpace  = locals())
EEEtri.addDiCandidateModule('triEEEdiElectrons','PATElePairProducer', 'smearedElectrons','smearedElectrons','smearedMET','smearedJets',1,genParticles='genDaughters')
EEEtri.addSelector('triEEEosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','triEEEDiEleCreation',1)
EEEtri.addDiCandidateModule('triEEEzzCands','PATEleEleEleTriProducer','triEEEosDiElectrons','smearedElectrons','smearedMET','smearedJets',1,9999,text='EEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEEtri.addSelector('triEEEzzEleIso','PATEleEleEleTriSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','triEEELeadingZEleIso')
EEEtri.addSelector('triEEEthirdEleID','PATEleEleEleTriSelector','leg2.pt()>7&&leg2.userFloat("SIP3D")<4','EEEthirdEleID')
...
MMMTantiIso1.addSelector('antiIso1MMMTosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50 && mass < 120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','MMMTDiMuonCreation',1)
...
MMMTantiIso1.addSelector('antiIso1MMMTzzMuIso','PATMuMuMuTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMMTLeadingZMuIso')
...
MMMTnoIsoSS.addSelector('noIsoSSMMMTosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50 && mass < 120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','MMMTDiMuonCreation',1)
...
MMMTnoIsoSS.addSelector('noIsoSSMMMTzzMuIso','PATMuMuMuTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMMTLeadingZMuIso')
...
MMMTantiIso2.addSelector('antiIso2MMMTosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','MMMTDiMuonCreation',1)
...
MMMTantiIso2.addSelector('antiIso2MMMTzzMuIso','PATMuMuMuTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMMTLeadingZMuIso')
...
MMMTantiIso2.addSelector('MMMTantiIso2F','PATMuMuMuTauQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.087)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.059) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','MMMTSecondZMuIso')
#create the sequence
...
MMMTantiIsoBoth.addSelector('antiIsoBothMMMTosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','MMMTDiMuonCreation',1)
...
MMTTantiIso1.addSelector('antiIso1MMTTosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','MMTT DiMuonCreation',1)
...
MMTTantiIso1.addSelector('antiIso1MMTTzzMuIso','PATMuMuTauTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMTTLeadingZMuIso')
...
MMTTnoIsoSS.addSelector('noIsoSSMMTTosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','MMTT DiMuonCreation',1)
...
MMTTnoIsoSS.addSelector('noIsoSSMMTTzzMuIso','PATMuMuTauTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMTTLeadingZMuIso')
...
MMTTantiIso2.addSelector('antiIso2MMTTosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','MMTT DiMuonCreation',1)
...
MMTTantiIso2.addSelector('antiIso2MMTTzzMuIso','PATMuMuTauTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMTTLeadingZMuIso')
...
MMTTantiIsoBoth.addSelector('antiIsoBothMMTTosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','MMTT DiMuonCreation',1)
...
MMETantiIso1.addSelector('antiIso1MMETosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','antiIso1MMET DiMuonCreation',1)
...
MMETantiIso1.addSelector('antiIso1MMETzzMuIso','PATMuMuEleTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso1MMETLeadingZMuIso')
...
MMETnoIsoSS.addSelector('noIsoSSMMETosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','noIsoSSMMET DiMuonCreation',1)
...
MMETnoIsoSS.addSelector('noIsoSSMMETzzMuIso','PATMuMuEleTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','noIsoSSMMETLeadingZMuIso')
...
MMETantiIso2.addSelector('antiIso2MMETosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','antiIso2MMET DiMuonCreation',1)
...
MMETantiIso2.addSelector('antiIso2MMETzzMuIso','PATMuMuEleTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso2MMETLeadingZMuIso')
...
MMETantiIso2.addSelector('MMETantiIso2F','PATMuMuEleTauQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.101)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.072) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','MMEMEleIso')
...
MMETantiIsoBoth.addSelector('antiIsoBothMMETosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','antiIsoBothMMET DiMuonCreation',1)
...
MMEMantiIso1.addSelector('antiIso1MMEMosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','MMEM DiMuonCreation',1)
...
MMEMantiIso1.addSelector('antiIso1MMEMzzMuIso','PATMuMuEleMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMEMLeadingZMuIso')
...
MMEMantiIso1.addSelector('MMEMantiIso1F','PATMuMuEleMuQuadSelector','((leg2.leg2.userIso(1)-leg2.leg2.userFloat("rho")*(0.087)+leg2.leg2.userIso(2)-leg2.leg2.userFloat("rho")*(0.059) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.20)','MMEMMuIso')
...
MMEMnoIsoSS.addSelector('noIsoSSMMEMosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','MMEM DiMuonCreation',1)
...
MMEMnoIsoSS.addSelector('noIsoSSMMEMzzMuIso','PATMuMuEleMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMEMLeadingZMuIso')
...
MMEMantiIso2.addSelector('antiIso2MMEMosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','MMEM DiMuonCreation',1)
...
MMEMantiIso2.addSelector('MMEMantiIso2F','PATMuMuEleMuQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.101)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.072) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','MMEMMuIso')
...
MMEMantiIsoBoth.addSelector('antiIsoBothMMEMosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','MMEM DiMuonCreation',1)
...
MMEMantiIsoBoth.addSelector('antiIsoBothMMEMzzMuIso','PATMuMuEleMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','MMEMLeadingZMuIso')
...
MMEEantiIso1.addSelector('antiIso1MMEEosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','antiIso1MMEE DiMuonCreation',1)
...
MMEEantiIso1.addSelector('antiIso1MMEEzzMuIso','PATMuMuEleEleQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso1MMEELeadingZMuIso')
...
#MMEEantiIso1.addSelector('MMEEnoIsoOSF','PATMuMuEleEleQuadSelector','((leg2.leg1.electronID("cicTight")==1||leg2.leg1.electronID("cicTight")==3||leg2.leg1.electronID("cicTight")==5||leg2.leg1.electronID("cicTight")==7||leg2.leg1.electronID("cicTight")==9||leg2.leg1.electronID("cicTight")==11||leg2.leg1.electronID("cicTight")==13||leg2.leg1.electronID("cicTight")==15)&&(leg2.leg2.electronID("cicTight")==1||leg2.leg2.electronID("cicTight")==3||leg2.leg2.electronID("cicTight")==5||leg2.leg2.electronID("cicTight")==7||leg2.leg2.electronID("cicTight")==9||leg2.leg2.electronID("cicTight")==11||leg2.leg2.electronID("cicTight")==13||leg2.leg2.electronID("cicTight")==15))','antiIso1MMEEEleCiCTight') 
...
MMEEantiIso1.addSelector('MMEEantiIso1F','PATMuMuEleEleQuadSelector','((leg2.leg2.userIso(1)-leg2.leg2.userFloat("rho")*(0.101)+leg2.leg2.userIso(2)-leg2.leg2.userFloat("rho")*(0.072) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.20)','antiIso1MMEEZEleIso')
...
MMEEnoIsoSS.addSelector('noIsoSSMMEEosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','noIsoSSMMEE DiMuonCreation',1)
...
MMEEnoIsoSS.addSelector('noIsoSSMMEEzzMuIso','PATMuMuEleEleQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','noIsoSSMMEELeadingZMuIso')
...
#MMEEnoIsoSS.addSelector('MMEEnoIsoSSF','PATMuMuEleEleQuadSelector','((leg2.leg1.electronID("cicTight")==1||leg2.leg1.electronID("cicTight")==3||leg2.leg1.electronID("cicTight")==5||leg2.leg1.electronID("cicTight")==7||leg2.leg1.electronID("cicTight")==9||leg2.leg1.electronID("cicTight")==11||leg2.leg1.electronID("cicTight")==13||leg2.leg1.electronID("cicTight")==15)&&(leg2.leg2.electronID("cicTight")==1||leg2.leg2.electronID("cicTight")==3||leg2.leg2.electronID("cicTight")==5||leg2.leg2.electronID("cicTight")==7||leg2.leg2.electronID("cicTight")==9||leg2.leg2.electronID("cicTight")==11||leg2.leg2.electronID("cicTight")==13||leg2.leg2.electronID("cicTight")==15))','noIsoSSMMEEEleCiCTight') 
...
MMEEantiIso2.addSelector('antiIso2MMEEosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','antiIso2MMEE DiMuonCreation',1)
...
MMEEantiIso2.addSelector('antiIso2MMEEzzMuIso','PATMuMuEleEleQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso2MMEELeadingZMuIso')
#MMEEantiIso2.addSelector('antiIso2MMEEnoIsoF2','PATMuMuEleEleQuadSelector','((leg2.leg1.electronID("cicTight")==1||leg2.leg1.electronID("cicTight")==3||leg2.leg1.electronID("cicTight")==5||leg2.leg1.electronID("cicTight")==7||leg2.leg1.electronID("cicTight")==9||leg2.leg1.electronID("cicTight")==11||leg2.leg1.electronID("cicTight")==13||leg2.leg1.electronID("cicTight")==15)&&(leg2.leg2.electronID("cicTight")==1||leg2.leg2.electronID("cicTight")==3||leg2.leg2.electronID("cicTight")==5||leg2.leg2.electronID("cicTight")==7||leg2.leg2.electronID("cicTight")==9||leg2.leg2.electronID("cicTight")==11||leg2.leg2.electronID("cicTight")==13||leg2.leg2.electronID("cicTight")==15))','antiIso2MMEEEleCiCTight') 
...
MMEEantiIsoBoth.addSelector('antiIsoBothMMEEosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','antiIsoBothMMEE DiMuonCreation',1)
...
#MMEEantiIsoBoth.addSelector('antiIsoBothMMEEnoIsoF2','PATMuMuEleEleQuadSelector','((leg2.leg1.electronID("cicTight")==1||leg2.leg1.electronID("cicTight")==3||leg2.leg1.electronID("cicTight")==5||leg2.leg1.electronID("cicTight")==7||leg2.leg1.electronID("cicTight")==9||leg2.leg1.electronID("cicTight")==11||leg2.leg1.electronID("cicTight")==13||leg2.leg1.electronID("cicTight")==15)&&(leg2.leg2.electronID("cicTight")==1||leg2.leg2.electronID("cicTight")==3||leg2.leg2.electronID("cicTight")==5||leg2.leg2.electronID("cicTight")==7||leg2.leg2.electronID("cicTight")==9||leg2.leg2.electronID("cicTight")==11||leg2.leg2.electronID("cicTight")==13||leg2.leg2.electronID("cicTight")==15))','antiIsoBothMMEEEleCiCTight') 
...
MMMMantiIso1.addSelector('antiIso1MMMMosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','antiIso1MMMM DiMuonCreation',1)
...
MMMMantiIso1.addSelector('MMMMantiIso1F','PATMuMuMuMuQuadSelector','((leg2.leg2.userIso(1)-leg2.leg2.userFloat("rho")*(0.087)+leg2.leg2.userIso(2)-leg2.leg2.userFloat("rho")*(0.059) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.20)','antiIso1MMMMSecondZMuIso')
...
MMMMnoIsoSS.addSelector('noIsoSSMMMMosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','noIsoSSMMMM DiMuonCreation',1)
...
MMMMantiIso2.addSelector('antiIso2MMMMosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','antiIso2MMMM DiMuonCreation',1)
...
MMMMantiIso2.addSelector('antiIso2MMMMzzMuIso','PATMuMuMuMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso2MMMMLeadingZMuIso')
...
MMMMantiIsoBoth.addSelector('antiIsoBothMMMMosDiMuons','PATMuPairSelector','charge==0&&leg1.isGlobalMuon()&&leg2.isGlobalMuon()&& mass>50&&mass<120 && abs(leg1.eta())<2.4 && abs(leg2.eta())<2.4&&leg1.pt()>20&&leg2.pt()>10','antiIsoBothMMMM DiMuonCreation',1)
...
EEMTantiIso1.addSelector('antiIso1EEMTosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','antiIso1EEMTDiEleCreation',1)
...
EEMTantiIso1.addSelector('antiIso1EEMTzzEleIso','PATEleEleMuTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso1EEMTLeadingZEleIso')
...
EEMTnoIsoSS.addSelector('noIsoSSEEMTosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','noIsoSSEEMTDiEleCreation',1)
...
EEMTnoIsoSS.addSelector('noIsoSSEEMTzzEleIso','PATEleEleMuTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','noIsoSSEEMTLeadingZEleIso')
...
EEMTantiIso2.addSelector('antiIso2EEMTosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','antiIso2EEMTDiEleCreation',1)
...
EEMTantiIso2.addSelector('antiIso2EEMTzzEleIso','PATEleEleMuTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso2EEMTLeadingZEleIso')
...
EEMTantiIso2.addSelector('EEMTantiIso2F','PATEleEleMuTauQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.087)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.059) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','antiIsoEEMTSecondZMuIso')
...
EEMTantiIsoBoth.addSelector('antiIsoBothEEMTosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','antiIsoBothEEMTDiEleCreation',1)
...
EEMTantiIsoBoth.addSelector('antiIsoBothEEMTzzEleIso','PATEleEleMuTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIsoBothEEMTLeadingZEleIso')
...
EEETantiIso1.addSelector('antiIso1EEETosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','antiIso1EEETDiEleCreation',1)
...
EEETantiIso1.addSelector('antiIso1EEETzzEleIso','PATEleEleEleTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso1EEETLeadingZEleIso')
...
EEETnoIsoSS.addSelector('noIsoSSEEETosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','noIsoSSEEETDiEleCreation',1)
...
EEETnoIsoSS.addSelector('noIsoSSEEETzzEleIso','PATEleEleEleTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','noIsoSSEEETLeadingZEleIso')
...
EEETantiIso2.addSelector('antiIso2EEETosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','antiIso2EEETDiEleCreation',1)
...
EEETantiIso2.addSelector('antiIso2EEETzzEleIso','PATEleEleEleTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso2EEETLeadingZEleIso')
...
EEETantiIso2.addSelector('EEETantiIso2F','PATEleEleEleTauQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.101)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.072) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','antiIsoEEETSecondZEleIso')
...
EEETantiIsoBoth.addSelector('antiIsoBothEEETosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','antiIsoBothEEETDiEleCreation',1)
...
EEETantiIsoBoth.addSelector('antiIsoBothEEETzzEleIso','PATEleEleEleTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIsoBothEEETLeadingZEleIso')
...
EETTantiIso1.addSelector('antiIso1EETTosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','antiIso1EETTDiEleCreation',1)
...
EETTantiIso1.addSelector('antiIso1EETTzzEleIso','PATEleEleTauTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso1EETTLeadingZEleIso')
...
EETTnoIsoSS.addSelector('noIsoSSEETTosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','noIsoSSEETTDiEleCreation',1)
...
EETTnoIsoSS.addSelector('noIsoSSEETTzzEleIso','PATEleEleTauTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','noIsoSSEETTLeadingZEleIso')
...
EETTantiIso2.addSelector('antiIso2EETTosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','antiIso2EETTDiEleCreation',1)
...
EETTantiIso2.addSelector('antiIso2EETTzzEleIso','PATEleEleTauTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso2EETTLeadingZEleIso')
...
EETTantiIsoBoth.addSelector('antiIsoBothEETTosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','antiIsoBothEETTDiEleCreation',1)
...
EETTantiIsoBoth.addSelector('antiIsoBothEETTzzEleIso','PATEleEleTauTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIsoBothEETTLeadingZEleIso')
...
EEEMantiIso1.addSelector('antiIso1EEEMosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','antiIso1EEEMDiEleCreation',1)
...
EEEMantiIso1.addSelector('antiIso1EEEMzzEleIso','PATEleEleEleMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso1EEEMLeadingZEleIso')
...
EEEMantiIso1.addSelector('EEEMantiIso1F','PATEleEleEleMuQuadSelector','((leg2.leg2.userIso(1)-leg2.leg2.userFloat("rho")*(0.087)+leg2.leg2.userIso(2)-leg2.leg2.userFloat("rho")*(0.059) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.20)','antiIso1EEEMSecondZMuIso')
...
EEEMnoIsoSS.addSelector('noIsoSSEEEMosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','noIsoSSEEEMDiEleCreation',1)
...
EEEMnoIsoSS.addSelector('noIsoSSEEEMzzEleIso','PATEleEleEleMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','noIsoSSEEEMLeadingZEleIso')
...
EEEMantiIso2.addSelector('antiIso2EEEMosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','antiIso2EEEMDiEleCreation',1)
...
EEEMantiIso2.addSelector('antiIso2EEEMzzEleIso','PATEleEleEleMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso2EEEMLeadingZEleIso')
...
EEEMantiIso2.addSelector('EEEMantiIso2F','PATEleEleEleMuQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.101)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.072) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','antiIsoEEEMSecondZEleIso')
...
EEEMantiIsoBoth.addSelector('antiIsoBothEEEMosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','antiIsoBothEEEMDiEleCreation',1)
...
EEEMantiIsoBoth.addSelector('antiIsoBothEEEMzzEleIso','PATEleEleEleMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIsoBothEEEMLeadingZEleIso')
...
EEEEantiIso1.addSelector('antiIso1EEEEosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','antiIso1EEEE DiEleCreation',1)
...
EEEEantiIso1.addSelector('antiIso1EEEEzzEleIso','PATEleEleEleEleQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso1EEEELeadingZEleIso')
...
#EEEEantiIso1.addSelector('EEEEnoIsoOSF','PATEleEleEleEleQuadSelector','((leg2.leg1.electronID("cicTight")==1||leg2.leg1.electronID("cicTight")==3||leg2.leg1.electronID("cicTight")==5||leg2.leg1.electronID("cicTight")==7||leg2.leg1.electronID("cicTight")==9||leg2.leg1.electronID("cicTight")==11||leg2.leg1.electronID("cicTight")==13||leg2.leg1.electronID("cicTight")==15)&&(leg2.leg2.electronID("cicTight")==1||leg2.leg2.electronID("cicTight")==3||leg2.leg2.electronID("cicTight")==5||leg2.leg2.electronID("cicTight")==7||leg2.leg2.electronID("cicTight")==9||leg2.leg2.electronID("cicTight")==11||leg2.leg2.electronID("cicTight")==13||leg2.leg2.electronID("cicTight")==15))','antiIso1EEEEsecondLegEleCiCTight')
...
EEEEantiIso1.addSelector('EEEEantiIso1F','PATEleEleEleEleQuadSelector','((leg2.leg2.userIso(1)-leg2.leg2.userFloat("rho")*(0.101)+leg2.leg2.userIso(2)-leg2.leg2.userFloat("rho")*(0.072) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.20)','antiIso1EEEESecondZEleIso')
...
EEEEnoIsoSS.addSelector('noIsoSSEEEEDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','noIsoSSEEEE DiEleCreation',1)
...
EEEEnoIsoSS.addSelector('noIsoSSEEEEzzEleIso','PATEleEleEleEleQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','noIsoSSEEEELeadingZEleIso')
...
#EEEEnoIsoSS.addSelector('EEEEnoIsoSSF','PATEleEleEleEleQuadSelector','((leg2.leg1.electronID("cicTight")==1||leg2.leg1.electronID("cicTight")==3||leg2.leg1.electronID("cicTight")==5||leg2.leg1.electronID("cicTight")==7||leg2.leg1.electronID("cicTight")==9||leg2.leg1.electronID("cicTight")==11||leg2.leg1.electronID("cicTight")==13||leg2.leg1.electronID("cicTight")==15)&&(leg2.leg2.electronID("cicTight")==1||leg2.leg2.electronID("cicTight")==3||leg2.leg2.electronID("cicTight")==5||leg2.leg2.electronID("cicTight")==7||leg2.leg2.electronID("cicTight")==9||leg2.leg2.electronID("cicTight")==11||leg2.leg2.electronID("cicTight")==13||leg2.leg2.electronID("cicTight")==15))','noIsoSSEEEEsecondLegEleCiCTight')
...
EEEEantiIso2.addSelector('antiIso2EEEEosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','antiIso2EEEE DiEleCreation',1)
...
EEEEantiIso2.addSelector('antiIso2EEEEzzEleIso','PATEleEleEleEleQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso2EEEELeadingZEleIso')
#EEEEantiIso2.addSelector('antiIso2EEEEzzEleIDSecond','PATEleEleEleEleQuadSelector','((leg2.leg1.electronID("cicTight")==1||leg2.leg1.electronID("cicTight")==3||leg2.leg1.electronID("cicTight")==5||leg2.leg1.electronID("cicTight")==7||leg2.leg1.electronID("cicTight")==9||leg2.leg1.electronID("cicTight")==11||leg2.leg1.electronID("cicTight")==13||leg2.leg1.electronID("cicTight")==15)&&(leg2.leg2.electronID("cicTight")==1||leg2.leg2.electronID("cicTight")==3||leg2.leg2.electronID("cicTight")==5||leg2.leg2.electronID("cicTight")==7||leg2.leg2.electronID("cicTight")==9||leg2.leg2.electronID("cicTight")==11||leg2.leg2.electronID("cicTight")==13||leg2.leg2.electronID("cicTight")==15))','antiIso2EEEEsecondLegEleCiCTight')
...
EEEEantiIso2.addSelector('EEEEantiIso2F','PATEleEleEleEleQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.101)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.072) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','antiIsoEEEESecondZEleIso')
...
EEEEantiIsoBoth.addSelector('antiIsoBothEEEEosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','antiIsoBothEEEE DiEleCreation',1)
...
EEEEantiIsoBoth.addSelector('antiIsoBothEEEEzzEleIso','PATEleEleEleEleQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIsoBothEEEELeadingZEleIso')
#EEEEantiIsoBoth.addSelector('antiIsoBothEEEEzzEleIDSecond','PATEleEleEleEleQuadSelector','((leg2.leg1.electronID("cicTight")==1||leg2.leg1.electronID("cicTight")==3||leg2.leg1.electronID("cicTight")==5||leg2.leg1.electronID("cicTight")==7||leg2.leg1.electronID("cicTight")==9||leg2.leg1.electronID("cicTight")==11||leg2.leg1.electronID("cicTight")==13||leg2.leg1.electronID("cicTight")==15)&&(leg2.leg2.electronID("cicTight")==1||leg2.leg2.electronID("cicTight")==3||leg2.leg2.electronID("cicTight")==5||leg2.leg2.electronID("cicTight")==7||leg2.leg2.electronID("cicTight")==9||leg2.leg2.electronID("cicTight")==11||leg2.leg2.electronID("cicTight")==13||leg2.leg2.electronID("cicTight")==15))','antiIsoBothEEEEsecondLegEleCiCTight')
...
EEMMantiIso1.addSelector('antiIso1EEMMosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','antiIso1EEMM DiEleCreation',1)
...
EEMMantiIso1.addSelector('antiIso1EEMMzzEleIso','PATEleEleMuMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso1EEMMLeadingZEleIso')
...
EEMMantiIso1.addSelector('EEMMantiIso1F','PATEleEleMuMuQuadSelector','((leg2.leg2.userIso(1)-leg2.leg2.userFloat("rho")*(0.087)+leg2.leg2.userIso(2)-leg2.leg2.userFloat("rho")*(0.059) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.20)','antiIso1EEMMLeadingZMuIso')
...
EEMMnoIsoSS.addSelector('noIsoSSEEMMosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','noIsoSSEEMM DiEleCreation',1)
...
EEMMnoIsoSS.addSelector('noIsoSSEEMMzzEleIso','PATEleEleMuMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','noIsoSSEEMMLeadingZEleIso')
...
EEMMantiIso2.addSelector('antiIso2EEMMosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','antiIso2EEMM DiEleCreation',1)
...
EEMMantiIso2.addSelector('antiIso2EEMMzzEleIso','PATEleEleMuMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIso2EEMMLeadingZEleIso')
...
EEMMantiIso2.addSelector('EEMMantiIso2F','PATEleEleMuMuQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.087)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.059) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','antiIsoEEMMLeadingZMuIso')
...
EEMMantiIsoBoth.addSelector('antiIsoBothEEMMosDiElectrons','PATElePairSelector','leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&leg2.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2&&(leg1.electronID("cicTight")==1||leg1.electronID("cicTight")==3||leg1.electronID("cicTight")==5||leg1.electronID("cicTight")==7||leg1.electronID("cicTight")==9||leg1.electronID("cicTight")==11||leg1.electronID("cicTight")==13||leg1.electronID("cicTight")==15)&&(leg2.electronID("cicTight")==1||leg2.electronID("cicTight")==3||leg2.electronID("cicTight")==5||leg2.electronID("cicTight")==7||leg2.electronID("cicTight")==9||leg2.electronID("cicTight")==11||leg2.electronID("cicTight")==13||leg2.electronID("cicTight")==15)&&charge==0&&mass>50&&mass<120&&abs(leg1.eta())<2.5&&abs(leg2.eta())<2.5&&leg1.pt()>20&&leg2.pt()>10','antiIsoBothEEMM DiEleCreation',1)
...
EEMMantiIsoBoth.addSelector('antiIsoBothEEMMzzEleIso','PATEleEleMuMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.30)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.30)','antiIsoBothEEMMLeadingZEleIso')
