...
##todo
#2. Trigger
MMMManalysisConfigurator.addHLTTest("MMMMHLT",DATAMC2012TriggerPaths,"HLT_req")
...
MMMManalysisConfigurator.addSelector('MMMMzzCleanedMuIso','PATMuMuMuMuQuadSelector','(leg2.leg1.chargedHadronIso()+max(0.0,leg2.leg1.neutralHadronIso()+leg2.leg1.photonIso()-leg2.leg1.userFloat("zzRho2012")*leg2.leg1.userFloat("EAGammaNeuHadron04")))/leg2.leg1.pt<0.40 && (leg2.leg2.chargedHadronIso()+max(0.0,leg2.leg2.neutralHadronIso()+leg2.leg2.photonIso()-leg2.leg2.userFloat("zzRho2012")*leg2.leg2.userFloat("EAGammaNeuHadron04")))/leg2.leg2.pt<0.40 ','two good Zs should lose none',1)
...
##todo
#2. Trigger
EEEEanalysisConfigurator.addHLTTest("EEEEHLT",DATAMC2012TriggerPaths,"EEEE HLT_req")
...
EEEEanalysisConfigurator.addSelector('EEEEosDiElectronsIso','PATElePairSelector','(leg1.chargedHadronIso()+max(0.0,leg1.neutralHadronIso()+leg1.photonIso()-leg1.userFloat("zzRho2012")*leg1.userFloat("EAGammaNeuHadron04")))/leg1.pt<0.40 && (leg2.chargedHadronIso()+max(0.0,leg2.neutralHadronIso()+leg2.photonIso()-leg2.userFloat("zzRho2012")*leg2.userFloat("EAGammaNeuHadron04")))/leg2.pt<0.40 ','one Z1 with iso eeee',1)
...
##4c. Pair #2 built (SF/OS, highest pT leptons) 
EEEEanalysisConfigurator.addSelector('EEEEzzCleanedEleIso','PATEleEleEleEleQuadSelector','(leg2.leg1.chargedHadronIso()+max(0.0,leg2.leg1.neutralHadronIso()+leg2.leg1.photonIso()-leg2.leg1.userFloat("zzRho2012")*leg2.leg1.userFloat("EAGammaNeuHadron04")))/leg2.leg1.pt<0.40 && (leg2.leg2.chargedHadronIso()+max(0.0,leg2.leg2.neutralHadronIso()+leg2.leg2.photonIso()-leg2.leg2.userFloat("zzRho2012")*leg2.leg2.userFloat("EAGammaNeuHadron04")))/leg2.leg2.pt<0.40 ','two good Zs eeee',1)
...
##todo
#2. Trigger
MMEEanalysisConfigurator.addHLTTest("MMEEHLT",DATAMC2012TriggerPaths,"MMEE HLT_req")
...
MMEEanalysisConfigurator.addSelector('MMEEosDiElectronsIso','PATElePairSelector','(leg1.chargedHadronIso()+max(0.0,leg1.neutralHadronIso()+leg1.photonIso()-leg1.userFloat("zzRho2012")*leg1.userFloat("EAGammaNeuHadron04")))/leg1.pt<0.40 && (leg2.chargedHadronIso()+max(0.0,leg2.neutralHadronIso()+leg2.photonIso()-leg2.userFloat("zzRho2012")*leg2.userFloat("EAGammaNeuHadron04")))/leg2.pt<0.40 ','a Z with iso ee should cut none',0)
...
##todo
#2. Trigger
absMMMManalysisConfigurator.addHLTTest("absMMMMHLT",MC2011TriggerPaths,"HLT_req abs")
...
absMMMManalysisConfigurator.addSelector('absMMMMosDiMuonsIso','PATMuPairSelector','( (leg1.pt()>10&&(leg1.chargedHadronIso()+max(0.0,leg1.neutralHadronIso()+leg1.photonIso()-leg1.userFloat("zzRho2012")*leg1.userFloat("EAGammaNeuHadron04")))/leg1.pt<0.40) || (leg1.pt()<10&&(leg1.chargedHadronIso()+max(0,0,leg1.neutralHadronIso()+leg1.photonIso()-leg1.userFloat("zzRho2012")*leg1.userFloat("EAGammaNeuHadron04")))<4.0)) && ((leg2.pt()>10&&(leg2.chargedHadronIso()+max(0.0,leg2.neutralHadronIso()+leg2.photonIso()-leg2.userFloat("zzRho2012")*leg2.userFloat("EAGammaNeuHadron04")))/leg2.pt<0.40)|| leg2.pt()<10&& (leg2.chargedHadronIso()+max(0.0,leg2.neutralHadronIso()+leg2.photonIso()-leg2.userFloat("zzRho2012")*leg2.userFloat("EAGammaNeuHadron04")))<4.0) ','one Z1 with iso abs',1)
...
#4c. Pair #2 built (SF/OS, highest pT leptons) 
absMMMManalysisConfigurator.addSelector('absMMMMzzCleanedMuIso','PATMuMuMuMuQuadSelector','( (leg2.leg1.pt()>10&&(leg2.leg1.chargedHadronIso()+max(0.0,leg2.leg1.neutralHadronIso()+leg2.leg1.photonIso()-leg2.leg1.userFloat("zzRho2012")*leg2.leg1.userFloat("EAGammaNeuHadron04")))/leg2.leg1.pt<0.40) || (leg2.leg1.pt()<10&&(leg2.leg1.chargedHadronIso()+max(0,0,leg2.leg1.neutralHadronIso()+leg2.leg1.photonIso()-leg2.leg1.userFloat("zzRho2012")*leg2.leg1.userFloat("EAGammaNeuHadron04")))<4.0)) && ((leg2.leg2.pt()>10&&(leg2.leg2.chargedHadronIso()+max(0.0,leg2.leg2.neutralHadronIso()+leg2.leg2.photonIso()-leg2.leg2.userFloat("zzRho2012")*leg2.leg2.userFloat("EAGammaNeuHadron04")))/leg2.leg2.pt<0.40)|| leg2.leg2.pt()<10&& (leg2.leg2.chargedHadronIso()+max(0.0,leg2.leg2.neutralHadronIso()+leg2.leg2.photonIso()-leg2.leg2.userFloat("zzRho2012")*leg2.leg2.userFloat("EAGammaNeuHadron04")))<4.0) ','two good Zs should lose none abs',1)
...
##todo
#2. Trigger
absEEEEanalysisConfigurator.addHLTTest("absEEEEHLT",MC2011TriggerPaths,"absEEEE HLT_req")
...
absEEEEanalysisConfigurator.addSelector('absEEEEosDiElectronsIso','PATElePairSelector','( (leg1.pt()>10&&(leg1.chargedHadronIso()+max(0.0,leg1.neutralHadronIso()+leg1.photonIso()-leg1.userFloat("zzRho2012")*leg1.userFloat("EAGammaNeuHadron04")))/leg1.pt<0.40) || (leg1.pt()<10&&(leg1.chargedHadronIso()+max(0,0,leg1.neutralHadronIso()+leg1.photonIso()-leg1.userFloat("zzRho2012")*leg1.userFloat("EAGammaNeuHadron04")))<4.0)) && ((leg2.pt()>10&&(leg2.chargedHadronIso()+max(0.0,leg2.neutralHadronIso()+leg2.photonIso()-leg2.userFloat("zzRho2012")*leg2.userFloat("EAGammaNeuHadron04")))/leg2.pt<0.40)|| leg2.pt()<10&& (leg2.chargedHadronIso()+max(0.0,leg2.neutralHadronIso()+leg2.photonIso()-leg2.userFloat("zzRho2012")*leg2.userFloat("EAGammaNeuHadron04")))<4.0) ','one Z1 with iso eeee abs',1)
...
##4c. Pair #2 built (SF/OS, highest pT leptons) 
#EEEEanalysisConfigurator.addSelector('absEEEEzzCleanedEleIso','PATEleEleEleEleQuadSelector','( (leg2.leg1.pt()>10&&(leg2.leg1.chargedHadronIso()+max(0.0,leg2.leg1.neutralHadronIso()+leg2.leg1.photonIso()-leg2.leg1.userFloat("zzRho2012")*leg2.leg1.userFloat("EAGammaNeuHadron04")))/leg2.leg1.pt<0.40) || (leg2.leg1.pt()<10&&(leg2.leg1.chargedHadronIso()+max(0,0,leg2.leg1.neutralHadronIso()+leg2.leg1.photonIso()-leg2.leg1.userFloat("zzRho2012")*leg2.leg1.userFloat("EAGammaNeuHadron04")))<4.0)) && ((leg2.leg2.pt()>10&&(leg2.leg2.chargedHadronIso()+max(0.0,leg2.leg2.neutralHadronIso()+leg2.leg2.photonIso()-leg2.leg2.userFloat("zzRho2012")*leg2.leg2.userFloat("EAGammaNeuHadron04")))/leg2.leg2.pt<0.40)|| leg2.leg2.pt()<10&& (leg2.leg2.chargedHadronIso()+max(0.0,leg2.leg2.neutralHadronIso()+leg2.leg2.photonIso()-leg2.leg2.userFloat("zzRho2012")*leg2.leg2.userFloat("EAGammaNeuHadron04")))<4.0) ','two good Zs eeee',1)
...
##todo
#2. Trigger
absMMEEanalysisConfigurator.addHLTTest("absMMEEHLT",MC2011TriggerPaths,"absMMEE HLT_req")
...
absMMEEanalysisConfigurator.addSelector('absMMEEosDiMuonsIso','PATMuPairSelector','( (leg1.pt()>10&&(leg1.chargedHadronIso()+max(0.0,leg1.neutralHadronIso()+leg1.photonIso()-leg1.userFloat("zzRho2012")*leg1.userFloat("EAGammaNeuHadron04")))/leg1.pt<0.40) || (leg1.pt()<10&&(leg1.chargedHadronIso()+max(0,0,leg1.neutralHadronIso()+leg1.photonIso()-leg1.userFloat("zzRho2012")*leg1.userFloat("EAGammaNeuHadron04")))<4.0)) && ((leg2.pt()>10&&(leg2.chargedHadronIso()+max(0.0,leg2.neutralHadronIso()+leg2.photonIso()-leg2.userFloat("zzRho2012")*leg2.userFloat("EAGammaNeuHadron04")))/leg2.pt<0.40)|| leg2.pt()<10&& (leg2.chargedHadronIso()+max(0.0,leg2.neutralHadronIso()+leg2.photonIso()-leg2.userFloat("zzRho2012")*leg2.userFloat("EAGammaNeuHadron04")))<4.0) ','one Z1 with iso absMMEE',1)
...
absMMEEanalysisConfigurator.addSelector('absMMEEosDiElectronsIso','PATElePairSelector','( (leg1.pt()>10&&(leg1.chargedHadronIso()+max(0.0,leg1.neutralHadronIso()+leg1.photonIso()-leg1.userFloat("zzRho2012")*leg1.userFloat("EAGammaNeuHadron04")))/leg1.pt<0.40) || (leg1.pt()<10&&(leg1.chargedHadronIso()+max(0,0,leg1.neutralHadronIso()+leg1.photonIso()-leg1.userFloat("zzRho2012")*leg1.userFloat("EAGammaNeuHadron04")))<4.0)) && ((leg2.pt()>10&&(leg2.chargedHadronIso()+max(0.0,leg2.neutralHadronIso()+leg2.photonIso()-leg2.userFloat("zzRho2012")*leg2.userFloat("EAGammaNeuHadron04")))/leg2.pt<0.40)|| leg2.pt()<10&& (leg2.chargedHadronIso()+max(0.0,leg2.neutralHadronIso()+leg2.photonIso()-leg2.userFloat("zzRho2012")*leg2.userFloat("EAGammaNeuHadron04")))<4.0) ','abs a Z with iso ee should cut none',0)
