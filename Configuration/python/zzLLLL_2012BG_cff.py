...
MMMtri.addDiCandidateModule('triMMMzzCands','PATMuMuMuTriProducer','triMMMosDiMuons','cleanPatMuons','systematicsMET','selectedPatJets',1,9999,text='MMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMEtri.addDiCandidateModule('triMMEzzCands','PATMuMuEleTriProducer','triMMEosDiMuons','mvaedElectrons','systematicsMET','selectedPatJets',1,9999,text='MMEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEMtri.addDiCandidateModule('triEEMzzCands','PATEleEleMuTriProducer','triEEMosDiMuons','cleanPatMuons','systematicsMET','selectedPatJets',1,9999,text='EEMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEEtri.addDiCandidateModule('triEEEzzCands','PATEleEleEleTriProducer','triEEEosDiMuons','mvaedElectrons','systematicsMET','selectedPatJets',1,9999,text='EEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMMTantiIso1.addSelector('antiIso1MMMTosDiMuons','PATMuPairSelector','charge==0&&leg1.userInt("tightID")>0.5 && abs(leg1.eta())<2.5','MMMTDiMuonCreation',1)
MMMTantiIso1.addDiCandidateModule('antiIso1MMMTmuTau','PATMuTauPairProducer', 'cleanPatMuons','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text = 'MMMTAtLeastOneMuTau',leadingObjectsOnly = False,dR = 0.5,recoMode = "",genParticles='genDaughters')
MMMTantiIso1.addDiCandidateModule('antiIso1MMMTzzCands','PATMuMuMuTauQuadProducer','antiIso1MMMTosDiMuons','antiIso1MMMTmuTau','systematicsMET','selectedPatJets',1,9999,text='MMMTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMMTnoIsoSS.addDiCandidateModule('noIsoSSMMMTmuTau','PATMuTauPairProducer', 'cleanPatMuons','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text = 'MMMTAtLeastOneMuTau',leadingObjectsOnly = False,dR = 0.5,recoMode = "",genParticles='genDaughters')
MMMTnoIsoSS.addDiCandidateModule('noIsoSSMMMTzzCands','PATMuMuMuTauQuadProducer','noIsoSSMMMTosDiMuons','noIsoSSMMMTmuTau','systematicsMET','selectedPatJets',1,9999,text='MMMTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMMTantiIso2.addDiCandidateModule('antiIso2MMMTmuTau','PATMuTauPairProducer', 'cleanPatMuons','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text = 'MMMTAtLeastOneMuTau',leadingObjectsOnly = False,dR = 0.5,recoMode = "",genParticles='genDaughters')
MMMTantiIso2.addDiCandidateModule('antiIso2MMMTzzCands','PATMuMuMuTauQuadProducer','antiIso2MMMTosDiMuons','antiIso2MMMTmuTau','systematicsMET','selectedPatJets',1,9999,text='MMMTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMMTantiIsoBoth.addDiCandidateModule('antiIsoBothMMMTmuTau','PATMuTauPairProducer', 'cleanPatMuons','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text = 'MMMTAtLeastOneMuTau',leadingObjectsOnly = False,dR = 0.5,recoMode = "",genParticles='genDaughters')
MMMTantiIsoBoth.addDiCandidateModule('antiIsoBothMMMTzzCands','PATMuMuMuTauQuadProducer','antiIsoBothMMMTosDiMuons','antiIsoBothMMMTmuTau','systematicsMET','selectedPatJets',1,9999,text='MMMTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMTTantiIso1.addDiCandidateModule('antiIso1MMTTdiTaus','PATDiTauPairProducer','cleanPatTaus','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text='MMTTAtLeastOneDiTau',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
MMTTantiIso1.addDiCandidateModule('antiIso1MMTTzzCands','PATMuMuTauTauQuadProducer','antiIso1MMTTosDiMuons','antiIso1MMTTdiTaus','systematicsMET','selectedPatJets',1,9999,text='MMTTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMTTnoIsoSS.addDiCandidateModule('noIsoSSMMTTdiTaus','PATDiTauPairProducer','cleanPatTaus','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text='MMTTAtLeastOneDiTau',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
MMTTnoIsoSS.addDiCandidateModule('noIsoSSMMTTzzCands','PATMuMuTauTauQuadProducer','noIsoSSMMTTosDiMuons','noIsoSSMMTTdiTaus','systematicsMET','selectedPatJets',1,9999,text='MMTTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMTTantiIso2.addDiCandidateModule('antiIso2MMTTdiTaus','PATDiTauPairProducer','cleanPatTaus','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text='MMTTAtLeastOneDiTau',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
MMTTantiIso2.addDiCandidateModule('antiIso2MMTTzzCands','PATMuMuTauTauQuadProducer','antiIso2MMTTosDiMuons','antiIso2MMTTdiTaus','systematicsMET','selectedPatJets',1,9999,text='MMTTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMTTantiIsoBoth.addDiCandidateModule('antiIsoBothMMTTdiTaus','PATDiTauPairProducer','cleanPatTaus','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text='MMTTAtLeastOneDiTau',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
MMTTantiIsoBoth.addDiCandidateModule('antiIsoBothMMTTzzCands','PATMuMuTauTauQuadProducer','antiIsoBothMMTTosDiMuons','antiIsoBothMMTTdiTaus','systematicsMET','selectedPatJets',1,9999,text='MMTTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMETantiIso1.addDiCandidateModule('antiIso1MMETelecTau','PATEleTauPairProducer','mvaedElectrons','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text='antiIso1MMETAtLeastOneDiTau',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
MMETantiIso1.addDiCandidateModule('antiIso1MMETzzCands','PATMuMuEleTauQuadProducer','antiIso1MMETosDiMuons','antiIso1MMETelecTau','systematicsMET','selectedPatJets',1,9999,text='antiIso1MMETAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMETnoIsoSS.addDiCandidateModule('noIsoSSMMETelecTau','PATEleTauPairProducer','mvaedElectrons','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text='noIsoSSMMETAtLeastOneDiTau',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
MMETnoIsoSS.addDiCandidateModule('noIsoSSMMETzzCands','PATMuMuEleTauQuadProducer','noIsoSSMMETosDiMuons','noIsoSSMMETelecTau','systematicsMET','selectedPatJets',1,9999,text='noIsoSSMMETAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMETantiIso2.addDiCandidateModule('antiIso2MMETelecTau','PATEleTauPairProducer','mvaedElectrons','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text='antiIso2MMETAtLeastOneDiTau',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
MMETantiIso2.addDiCandidateModule('antiIso2MMETzzCands','PATMuMuEleTauQuadProducer','antiIso2MMETosDiMuons','antiIso2MMETelecTau','systematicsMET','selectedPatJets',1,9999,text='antiIso2MMETAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMETantiIsoBoth.addDiCandidateModule('antiIsoBothMMETelecTau','PATEleTauPairProducer','mvaedElectrons','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text='antiIsoBothMMETAtLeastOneDiTau',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
MMETantiIsoBoth.addDiCandidateModule('antiIsoBothMMETzzCands','PATMuMuEleTauQuadProducer','antiIsoBothMMETosDiMuons','antiIsoBothMMETelecTau','systematicsMET','selectedPatJets',1,9999,text='antiIsoBothMMETAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMEMantiIso1.addDiCandidateModule('antiIso1MMEMelecMu','PATEleMuPairProducer','mvaedElectrons','cleanPatMuons','systematicsMET','selectedPatJets',1,9999,text='MMEMAtLeastOneDiTau',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
MMEMantiIso1.addDiCandidateModule('antiIso1MMEMzzCands','PATMuMuEleMuQuadProducer','antiIso1MMEMosDiMuons','antiIso1MMEMelecMu','systematicsMET','selectedPatJets',1,9999,text='MMEMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMEMnoIsoSS.addDiCandidateModule('noIsoSSMMEMelecMu','PATEleMuPairProducer','mvaedElectrons','cleanPatMuons','systematicsMET','selectedPatJets',1,9999,text='MMEMAtLeastOneDiTau',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
MMEMnoIsoSS.addDiCandidateModule('noIsoSSMMEMzzCands','PATMuMuEleMuQuadProducer','noIsoSSMMEMosDiMuons','noIsoSSMMEMelecMu','systematicsMET','selectedPatJets',1,9999,text='MMEMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMEMantiIso2.addDiCandidateModule('antiIso2MMEMelecMu','PATEleMuPairProducer','mvaedElectrons','cleanPatMuons','systematicsMET','selectedPatJets',1,9999,text='MMEMAtLeastOneDiTau',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
MMEMantiIso2.addDiCandidateModule('antiIso2MMEMzzCands','PATMuMuEleMuQuadProducer','antiIso2MMEMosDiMuons','antiIso2MMEMelecMu','systematicsMET','selectedPatJets',1,9999,text='MMEMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMEMantiIsoBoth.addDiCandidateModule('antiIsoBothMMEMelecMu','PATEleMuPairProducer','mvaedElectrons','cleanPatMuons','systematicsMET','selectedPatJets',1,9999,text='MMEMAtLeastOneDiTau',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
MMEMantiIsoBoth.addDiCandidateModule('antiIsoBothMMEMzzCands','PATMuMuEleMuQuadProducer','antiIsoBothMMEMosDiMuons','antiIsoBothMMEMelecMu','systematicsMET','selectedPatJets',1,9999,text='MMEMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMEEantiIso1.addDiCandidateModule('antiIso1MMEEeleEle','PATElePairProducer','mvaedElectrons','mvaedElectrons','systematicsMET','selectedPatJets',1,9999,text='antiIso1MMEEAtLeastOneEleEle',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
MMEEantiIso1.addDiCandidateModule('antiIso1MMEEzzCands','PATMuMuEleEleQuadProducer','antiIso1MMEEosDiMuons','antiIso1MMEEeleEle','systematicsMET','selectedPatJets',1,9999,text='antiIso1MMEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMEEnoIsoSS.addDiCandidateModule('noIsoSSMMEEeleEle','PATElePairProducer','mvaedElectrons','mvaedElectrons','systematicsMET','selectedPatJets',1,9999,text='noIsoSSMMEEAtLeastOneEleEle',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
MMEEnoIsoSS.addDiCandidateModule('noIsoSSMMEEzzCands','PATMuMuEleEleQuadProducer','noIsoSSMMEEosDiMuons','noIsoSSMMEEeleEle','systematicsMET','selectedPatJets',1,9999,text='noIsoSSMMEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMEEantiIso2.addDiCandidateModule('antiIso2MMEEeleEle','PATElePairProducer','mvaedElectrons','mvaedElectrons','systematicsMET','selectedPatJets',1,9999,text='antiIso2MMEEAtLeastOneEleEle',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
MMEEantiIso2.addDiCandidateModule('antiIso2MMEEzzCands','PATMuMuEleEleQuadProducer','antiIso2MMEEosDiMuons','antiIso2MMEEeleEle','systematicsMET','selectedPatJets',1,9999,text='antiIso2MMEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMEEantiIsoBoth.addDiCandidateModule('antiIsoBothMMEEeleEle','PATElePairProducer','mvaedElectrons','mvaedElectrons','systematicsMET','selectedPatJets',1,9999,text='antiIsoBothMMEEAtLeastOneEleEle',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
MMEEantiIsoBoth.addDiCandidateModule('antiIsoBothMMEEzzCands','PATMuMuEleEleQuadProducer','antiIsoBothMMEEosDiMuons','antiIsoBothMMEEeleEle','systematicsMET','selectedPatJets',1,9999,text='antiIsoBothMMEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMMMantiIso1.addDiCandidateModule('antiIso1MMMMzzCands','PATMuMuMuMuQuadProducer','antiIso1MMMMosDiMuons','antiIso1MMMMdiMuons','systematicsMET','selectedPatJets',1,9999,text='antiIso1MMMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMMMnoIsoSS.addDiCandidateModule('noIsoSSMMMMzzCands','PATMuMuMuMuQuadProducer','noIsoSSMMMMosDiMuons','noIsoSSMMMMdiMuons','systematicsMET','selectedPatJets',1,9999,text='noIsoSSMMMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMMMantiIso2.addDiCandidateModule('antiIso2MMMMzzCands','PATMuMuMuMuQuadProducer','antiIso2MMMMosDiMuons','antiIso2MMMMdiMuons','systematicsMET','selectedPatJets',1,9999,text='antiIso2MMMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMMMantiIsoBoth.addDiCandidateModule('antiIsoBothMMMMzzCands','PATMuMuMuMuQuadProducer','antiIsoBothMMMMosDiMuons','antiIsoBothMMMMdiMuons','systematicsMET','selectedPatJets',1,9999,text='antiIsoBothMMMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEMTantiIso1.addDiCandidateModule('antiIso1EEMTmuTau','PATMuTauPairProducer', 'cleanPatMuons','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text = 'antiIso1EEMTAtLeastOneMuTau',leadingObjectsOnly = False,dR = 0.5,recoMode = "",genParticles='genDaughters')
EEMTantiIso1.addDiCandidateModule('antiIso1EEMTzzCands','PATEleEleMuTauQuadProducer','antiIso1EEMTosDiElectrons','antiIso1EEMTmuTau','systematicsMET','selectedPatJets',1,9999,text='antiIso1EEMTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEMTnoIsoSS.addDiCandidateModule('noIsoSSEEMTmuTau','PATMuTauPairProducer', 'cleanPatMuons','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text = 'noIsoSSEEMTAtLeastOneMuTau',leadingObjectsOnly = False,dR = 0.5,recoMode = "",genParticles='genDaughters')
EEMTnoIsoSS.addDiCandidateModule('noIsoSSEEMTzzCands','PATEleEleMuTauQuadProducer','noIsoSSEEMTosDiElectrons','noIsoSSEEMTmuTau','systematicsMET','selectedPatJets',1,9999,text='noIsoSSEEMTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEMTantiIso2.addDiCandidateModule('antiIso2EEMTmuTau','PATMuTauPairProducer', 'cleanPatMuons','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text = 'antiIso2EEMTAtLeastOneMuTau',leadingObjectsOnly = False,dR = 0.5,recoMode = "",genParticles='genDaughters')
EEMTantiIso2.addDiCandidateModule('antiIso2EEMTzzCands','PATEleEleMuTauQuadProducer','antiIso2EEMTosDiElectrons','antiIso2EEMTmuTau','systematicsMET','selectedPatJets',1,9999,text='antiIso2EEMTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEMTantiIsoBoth.addDiCandidateModule('antiIsoBothEEMTmuTau','PATMuTauPairProducer', 'cleanPatMuons','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text = 'antiIsoBothEEMTAtLeastOneMuTau',leadingObjectsOnly = False,dR = 0.5,recoMode = "",genParticles='genDaughters')
EEMTantiIsoBoth.addDiCandidateModule('antiIsoBothEEMTzzCands','PATEleEleMuTauQuadProducer','antiIsoBothEEMTosDiElectrons','antiIsoBothEEMTmuTau','systematicsMET','selectedPatJets',1,9999,text='antiIsoBothEEMTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEETantiIso1.addDiCandidateModule('antiIso1EEETeleTau','PATEleTauPairProducer', 'mvaedElectrons','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text = 'antiIso1EEETAtLeastOneEleTau',leadingObjectsOnly = False,dR = 0.5,recoMode = "",genParticles='genDaughters')
EEETantiIso1.addDiCandidateModule('antiIso1EEETzzCands','PATEleEleEleTauQuadProducer','antiIso1EEETosDiElectrons','antiIso1EEETeleTau','systematicsMET','selectedPatJets',1,9999,text='antiIso1EEETAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEETnoIsoSS.addDiCandidateModule('noIsoSSEEETeleTau','PATEleTauPairProducer', 'mvaedElectrons','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text = 'noIsoSSEEETAtLeastOneEleTau',leadingObjectsOnly = False,dR = 0.5,recoMode = "",genParticles='genDaughters')
EEETnoIsoSS.addDiCandidateModule('noIsoSSEEETzzCands','PATEleEleEleTauQuadProducer','noIsoSSEEETosDiElectrons','noIsoSSEEETeleTau','systematicsMET','selectedPatJets',1,9999,text='noIsoSSEEETAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEETantiIso2.addDiCandidateModule('antiIso2EEETeleTau','PATEleTauPairProducer', 'mvaedElectrons','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text = 'antiIso2EEETAtLeastOneEleTau',leadingObjectsOnly = False,dR = 0.5,recoMode = "",genParticles='genDaughters')
EEETantiIso2.addDiCandidateModule('antiIso2EEETzzCands','PATEleEleEleTauQuadProducer','antiIso2EEETosDiElectrons','antiIso2EEETeleTau','systematicsMET','selectedPatJets',1,9999,text='antiIso2EEETAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEETantiIsoBoth.addDiCandidateModule('antiIsoBothEEETeleTau','PATEleTauPairProducer', 'mvaedElectrons','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text = 'antiIsoBothEEETAtLeastOneEleTau',leadingObjectsOnly = False,dR = 0.5,recoMode = "",genParticles='genDaughters')
EEETantiIsoBoth.addDiCandidateModule('antiIsoBothEEETzzCands','PATEleEleEleTauQuadProducer','antiIsoBothEEETosDiElectrons','antiIsoBothEEETeleTau','systematicsMET','selectedPatJets',1,9999,text='antiIsoBothEEETAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EETTantiIso1.addDiCandidateModule('antiIso1EETTtauTau','PATDiTauPairProducer', 'cleanPatTaus','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text = 'antiIso1EETTAtLeastOnediTau',leadingObjectsOnly = False,dR = 0.5,recoMode = "",genParticles='genDaughters')
EETTantiIso1.addDiCandidateModule('antiIso1EETTzzCands','PATEleEleTauTauQuadProducer','antiIso1EETTosDiElectrons','antiIso1EETTtauTau','systematicsMET','selectedPatJets',1,9999,text='antiIso1EETTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EETTnoIsoSS.addDiCandidateModule('noIsoSSEETTtauTau','PATDiTauPairProducer', 'cleanPatTaus','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text = 'noIsoSSEETTAtLeastOnediTau',leadingObjectsOnly = False,dR = 0.5,recoMode = "",genParticles='genDaughters')
EETTnoIsoSS.addDiCandidateModule('noIsoSSEETTzzCands','PATEleEleTauTauQuadProducer','noIsoSSEETTosDiElectrons','noIsoSSEETTtauTau','systematicsMET','selectedPatJets',1,9999,text='noIsoSSEETTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EETTantiIso2.addDiCandidateModule('antiIso2EETTtauTau','PATDiTauPairProducer', 'cleanPatTaus','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text = 'antiIso2EETTAtLeastOnediTau',leadingObjectsOnly = False,dR = 0.5,recoMode = "",genParticles='genDaughters')
EETTantiIso2.addDiCandidateModule('antiIso2EETTzzCands','PATEleEleTauTauQuadProducer','antiIso2EETTosDiElectrons','antiIso2EETTtauTau','systematicsMET','selectedPatJets',1,9999,text='antiIso2EETTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EETTantiIsoBoth.addDiCandidateModule('antiIsoBothEETTtauTau','PATDiTauPairProducer', 'cleanPatTaus','cleanPatTaus','systematicsMET','selectedPatJets',1,9999,text = 'antiIsoBothEETTAtLeastOnediTau',leadingObjectsOnly = False,dR = 0.5,recoMode = "",genParticles='genDaughters')
EETTantiIsoBoth.addDiCandidateModule('antiIsoBothEETTzzCands','PATEleEleTauTauQuadProducer','antiIsoBothEETTosDiElectrons','antiIsoBothEETTtauTau','systematicsMET','selectedPatJets',1,9999,text='antiIsoBothEETTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEEMantiIso1.addDiCandidateModule('antiIso1EEEMeleMu','PATEleMuPairProducer', 'mvaedElectrons','cleanPatMuons','systematicsMET','selectedPatJets',1,9999,text = 'antiIso1EEEMAtLeastOneMuTau',leadingObjectsOnly = False,dR = 0.5,recoMode = "",genParticles='genDaughters')
EEEMantiIso1.addDiCandidateModule('antiIso1EEEMzzCands','PATEleEleEleMuQuadProducer','antiIso1EEEMosDiElectrons','antiIso1EEEMeleMu','systematicsMET','selectedPatJets',1,9999,text='antiIso1EEEMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEEMnoIsoSS.addDiCandidateModule('noIsoSSEEEMeleMu','PATEleMuPairProducer', 'mvaedElectrons','cleanPatMuons','systematicsMET','selectedPatJets',1,9999,text = 'noIsoSSEEEMAtLeastOneMuTau',leadingObjectsOnly = False,dR = 0.5,recoMode = "",genParticles='genDaughters')
EEEMnoIsoSS.addDiCandidateModule('noIsoSSEEEMzzCands','PATEleEleEleMuQuadProducer','noIsoSSEEEMosDiElectrons','noIsoSSEEEMeleMu','systematicsMET','selectedPatJets',1,9999,text='noIsoSSEEEMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEEMantiIso2.addDiCandidateModule('antiIso2EEEMeleMu','PATEleMuPairProducer', 'mvaedElectrons','cleanPatMuons','systematicsMET','selectedPatJets',1,9999,text = 'antiIso2EEEMAtLeastOneMuTau',leadingObjectsOnly = False,dR = 0.5,recoMode = "",genParticles='genDaughters')
EEEMantiIso2.addDiCandidateModule('antiIso2EEEMzzCands','PATEleEleEleMuQuadProducer','antiIso2EEEMosDiElectrons','antiIso2EEEMeleMu','systematicsMET','selectedPatJets',1,9999,text='antiIso2EEEMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEEMantiIsoBoth.addDiCandidateModule('antiIsoBothEEEMeleMu','PATEleMuPairProducer', 'mvaedElectrons','cleanPatMuons','systematicsMET','selectedPatJets',1,9999,text = 'antiIsoBothEEEMAtLeastOneMuTau',leadingObjectsOnly = False,dR = 0.5,recoMode = "",genParticles='genDaughters')
EEEMantiIsoBoth.addDiCandidateModule('antiIsoBothEEEMzzCands','PATEleEleEleMuQuadProducer','antiIsoBothEEEMosDiElectrons','antiIsoBothEEEMeleMu','systematicsMET','selectedPatJets',1,9999,text='antiIsoBothEEEMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEEEantiIso1.addDiCandidateModule('antiIso1EEEEzzCands','PATEleEleEleEleQuadProducer','antiIso1EEEEosDiElectrons','antiIso1EEEEdiElectrons','systematicsMET','selectedPatJets',1,9999,text='antiIso1EEEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEEEnoIsoSS.addDiCandidateModule('noIsoSSEEEEzzCands','PATEleEleEleEleQuadProducer','noIsoSSEEEEosDiElectrons','noIsoSSEEEEdiElectrons','systematicsMET','selectedPatJets',1,9999,text='noIsoSSEEEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEEEantiIso2.addDiCandidateModule('antiIso2EEEEzzCands','PATEleEleEleEleQuadProducer','antiIso2EEEEosDiElectrons','antiIso2EEEEdiElectrons','systematicsMET','selectedPatJets',1,9999,text='antiIso2EEEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEEEantiIsoBoth.addDiCandidateModule('antiIsoBothEEEEzzCands','PATEleEleEleEleQuadProducer','antiIsoBothEEEEosDiElectrons','antiIsoBothEEEEdiElectrons','systematicsMET','selectedPatJets',1,9999,text='antiIsoBothEEEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEMMantiIso1.addDiCandidateModule('antiIso1EEMMzzCands','PATEleEleMuMuQuadProducer','antiIso1EEMMosDiElectrons','antiIso1EEMMdiMuons','systematicsMET','selectedPatJets',1,9999,text='antiIso1EEMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEMMnoIsoSS.addDiCandidateModule('noIsoSSEEMMzzCands','PATEleEleMuMuQuadProducer','noIsoSSEEMMosDiElectrons','noIsoSSEEMMdiMuons','systematicsMET','selectedPatJets',1,9999,text='noIsoSSEEMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEMMantiIso2.addDiCandidateModule('antiIso2EEMMzzCands','PATEleEleMuMuQuadProducer','antiIso2EEMMosDiElectrons','antiIso2EEMMdiMuons','systematicsMET','selectedPatJets',1,9999,text='antiIso2EEMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEMMantiIsoBoth.addDiCandidateModule('antiIsoBothEEMMzzCands','PATEleEleMuMuQuadProducer','antiIsoBothEEMMosDiElectrons','antiIsoBothEEMMdiMuons','systematicsMET','selectedPatJets',1,9999,text='antiIsoBothEEMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMEEanalysisConfigurator.addDiCandidateModule('MMEEeleEle','PATElePairProducer','mvaedElectrons','mvaedElectrons','systematicsMET','selectedPatJets',1,9999,text='MMEEAtLeastOneEleEle',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
MMEEanalysisConfigurator.addDiCandidateModule('MMEEzzCands','PATMuMuEleEleQuadProducer','MMEEosDiMuons','MMEEeleEle','systematicsMET','selectedPatJets',1,9999,text='MMEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
MMMManalysisConfigurator.addDiCandidateModule('MMMMzzCands','PATMuMuMuMuQuadProducer','MMMMosDiMuons','MMMMdiMuons','systematicsMET','selectedPatJets',1,9999,text='MMMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEEEanalysisConfigurator.addDiCandidateModule('EEEEzzCands','PATEleEleEleEleQuadProducer','EEEEosDiElectrons','EEEEdiElectrons','systematicsMET','selectedPatJets',1,9999,text='EEEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
...
EEMManalysisConfigurator.addDiCandidateModule('EEMMzzCands','PATEleEleMuMuQuadProducer','EEMMosDiElectrons','EEMMdiMuons','systematicsMET','selectedPatJets',1,9999,text='EEMMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.5,recoMode ="",genParticles='genDaughters')
