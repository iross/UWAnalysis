...
MMMTanalysisConfigurator.addSelector('MMMTzzMuIso2','PATMuMuMuTauQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.087)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.059) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','MMMTSecondZMuIso')
...
MMTTanalysisConfigurator.addDiCandidateModule('MMTTzzCands','PATMuMuTauTauQuadProducer','MMTTosDiMuons','MMTTdiTaus','smearedMETMMTT','smearedJetsMMTT',1,9999,text='MMTTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.01,recoMode ="",genParticles='genDaughters')
...
MMETanalysisConfigurator.addDiCandidateModule('MMETzzCands','PATMuMuEleTauQuadProducer','MMETosDiMuons','MMETelecTau','smearedMETMMET','smearedJetsMMET',1,9999,text='MMETAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.01,recoMode ="",genParticles='genDaughters')
...
MMETanalysisConfigurator.addSelector('MMETzzMuIso','PATMuMuEleTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','MMETLeadingZMuIso')
...
MMETanalysisConfigurator.addSelector('MMETzzCleanedEleIso','PATMuMuEleTauQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.101)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.072) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','MMETEleIso')
...
MMEManalysisConfigurator.addDiCandidateModule('MMEMelecMu','PATEleMuPairProducer','smearedElectronsMMEM','smearedMuonsMMEM','smearedMETMMEM','smearedJetsMMEM',1,9999,text='MMEMAtLeastOneDiTau',leadingObjectsOnly = False,dR = 0.3,recoMode ="",genParticles='genDaughters')
MMEManalysisConfigurator.addDiCandidateModule('MMEMzzCands','PATMuMuEleMuQuadProducer','MMEMosDiMuons','MMEMelecMu','smearedMETMMEM','smearedJetsMMEM',1,9999,text='MMEMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.01,recoMode ="",genParticles='genDaughters')
...
MMEManalysisConfigurator.addSelector('MMEMzzMuIso','PATMuMuEleMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.087)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.087)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.059) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','MMEMLeadingZMuIso')
...
MMEManalysisConfigurator.addSelector('MMEMzzEleIso','PATMuMuEleMuQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.101)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.072) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.40)','MMEMEleIso')
MMEManalysisConfigurator.addSelector('MMEMzzMuIso2','PATMuMuEleMuQuadSelector','((leg2.leg2.userIso(1)-leg2.leg2.userFloat("rho")*(0.087)+leg2.leg2.userIso(2)-leg2.leg2.userFloat("rho")*(0.059) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.40)','MMEMMuIso')
...
EEMTanalysisConfigurator.addDiCandidateModule('EEMTzzCands','PATEleEleMuTauQuadProducer','EEMTosDiElectrons','EEMTmuTau','smearedMETEEMT','smearedJetsEEMT',1,9999,text='EEMTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.01,recoMode ="",genParticles='genDaughters')
...
EEMTanalysisConfigurator.addSelector('EEMTzzEleIso','PATEleEleMuTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.072) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','EEMTLeadingZEleIso')
...
EEMTanalysisConfigurator.addSelector('EEMTzzMuIso','PATEleEleMuTauQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.087)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.059) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','EEMTSecondZMuIso')
...
EEETanalysisConfigurator.addDiCandidateModule('EEETzzCands','PATEleEleEleTauQuadProducer','EEETosDiElectrons','EEETeleTau','smearedMETEEET','smearedJetsEEET',1,9999,text='EEETAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.01,recoMode ="",genParticles='genDaughters')
...
EEETanalysisConfigurator.addSelector('EEETzzEleIso','PATEleEleEleTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','EEETLeadingZEleIso')
...
EEETanalysisConfigurator.addSelector('EEETzzEleIso2','PATEleEleEleTauQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.101)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.072) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','EEETSecondZEleIso')
...
EETTanalysisConfigurator.addDiCandidateModule('EETTzzCands','PATEleEleTauTauQuadProducer','EETTosDiElectrons','EETTtauTau','smearedMETEETT','smearedJetsEETT',1,9999,text='EETTAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.01,recoMode ="",genParticles='genDaughters')
...
EETTanalysisConfigurator.addSelector('EETTzzEleIso','PATEleEleTauTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','EETTLeadingZEleIso')
...
EEEManalysisConfigurator.addDiCandidateModule('EEEMzzCands','PATEleEleEleMuQuadProducer','EEEMosDiElectrons','EEEMeleMu','smearedMETEEEM','smearedJetsEEEM',1,9999,text='EEEMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.01,recoMode ="",genParticles='genDaughters')
...
EEEManalysisConfigurator.addSelector('EEEMzzEleIso','PATEleEleEleMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.101)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.059) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.101)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.072) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','EEEMLeadingZEleIso')
...
EEEManalysisConfigurator.addSelector('EEEMzzEleIso2','PATEleEleEleMuQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.101)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.072) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','EEEMSecondZEleIso')
EEEManalysisConfigurator.addSelector('EEEMzzMuIso2','PATEleEleEleMuQuadSelector','((leg2.leg2.userIso(1)-leg2.leg2.userFloat("rho")*(0.087)+leg2.leg2.userIso(2)-leg2.leg2.userFloat("rho")*(0.059) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.20)','EEEMSecondZMuIso')
