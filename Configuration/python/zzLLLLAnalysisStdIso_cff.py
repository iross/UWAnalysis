...
MMMTanalysisConfigurator.addSelector('MMMTzzMuIso','PATMuMuMuTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.022) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.022) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','MMMTLeadingZMuIso')
...
MMMTanalysisConfigurator.addSelector('MMMTzzMuIso2','PATMuMuMuTauQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.045)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.022) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','MMMTSecondZMuIso')
...
MMTTanalysisConfigurator.addSelector('MMTTzzMuIso','PATMuMuTauTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.022) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.022) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','MMTTLeadingZMuIso')
...
MMETanalysisConfigurator.addSelector('MMETzzMuIso','PATMuMuEleTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.022) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.022) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','MMETLeadingZMuIso')
...
MMETanalysisConfigurator.addSelector('MMETzzCleanedEleIso','PATMuMuEleTauQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.046)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.021) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','MMETEleIso')
...
MMEManalysisConfigurator.addSelector('MMEMzzMuIso','PATMuMuEleMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.022) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.022) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','MMEMLeadingZMuIso')
...
MMEManalysisConfigurator.addSelector('MMEMzzEleIso','PATMuMuEleMuQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.046)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.021) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.40)','MMEMEleIso')
MMEManalysisConfigurator.addSelector('MMEMzzMuIso2','PATMuMuEleMuQuadSelector','((leg2.leg2.userIso(1)-leg2.leg2.userFloat("rho")*(0.045)+leg2.leg2.userIso(2)-leg2.leg2.userFloat("rho")*(0.022) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.40)','MMEMMuIso')
...
MMEEanalysisConfigurator.addSelector('MMEEzzMuIso','PATMuMuEleEleQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.022) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.022) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','MMEELeadingZMuIso')
...
MMEEanalysisConfigurator.addSelector('MMEEzzEleIso','PATMuMuEleEleQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.046)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.021) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.40)&&((leg2.leg2.userIso(1)-leg2.leg2.userFloat("rho")*(0.046)+leg2.leg2.userIso(2)-leg2.leg2.userFloat("rho")*(0.021) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.40)','MMEEZEleIso')
...
MMMManalysisConfigurator.addSelector('MMMMzzMuIso','PATMuMuMuMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.045)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.022) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.022) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','MMMMLeadingZMuIso')
...
MMMManalysisConfigurator.addSelector('MMMMzzMuIso2','PATMuMuMuMuQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.045)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.022) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.40)&&((leg2.leg2.userIso(1)-leg2.leg2.userFloat("rho")*(0.045)+leg2.leg2.userIso(2)-leg2.leg2.userFloat("rho")*(0.022) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.40)','MMMMSecondZMuIso')
...
EEMTanalysisConfigurator.addSelector('EEMTzzEleIso','PATEleEleMuTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.046)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.021) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.046)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.021) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','EEMTLeadingZEleIso')
...
EEMTanalysisConfigurator.addSelector('EEMTzzMuIso','PATEleEleMuTauQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.045)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.022) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','EEMTSecondZMuIso')
...
EEETanalysisConfigurator.addSelector('EEETzzEleIso','PATEleEleEleTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.046)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.022) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.046)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.022) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','EEETLeadingZEleIso')
...
EEETanalysisConfigurator.addSelector('EEETzzEleIso2','PATEleEleEleTauQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.046)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.022) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','EEETSecondZEleIso')
...
EETTanalysisConfigurator.addSelector('EETTzzEleIso','PATEleEleTauTauQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.046)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.022) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.046)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.022) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','EETTLeadingZEleIso')
...
EEEManalysisConfigurator.addSelector('EEEMzzEleIso','PATEleEleEleMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.046)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.022) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.046)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.022) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','EEEMLeadingZEleIso')
...
EEEManalysisConfigurator.addSelector('EEEMzzEleIso2','PATEleEleEleMuQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.046)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.022) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.20)','EEEMSecondZEleIso')
EEEManalysisConfigurator.addSelector('EEEMzzMuIso2','PATEleEleEleMuQuadSelector','((leg2.leg2.userIso(1)-leg2.leg2.userFloat("rho")*(0.045)+leg2.leg2.userIso(2)-leg2.leg2.userFloat("rho")*(0.021) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.20)','EEEMSecondZMuIso')
...
EEEEanalysisConfigurator.addSelector('EEEEzzEleIso','PATEleEleEleEleQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.046)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.021) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.046)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.021) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','EEEELeadingZEleIso')
...
EEEEanalysisConfigurator.addSelector('EEEEzzEleIso2','PATEleEleEleEleQuadSelector','((leg2.leg1.userIso(1)-leg2.leg1.userFloat("rho")*(0.046)+leg2.leg1.userIso(2)-leg2.leg1.userFloat("rho")*(0.021) + leg2.leg1.userIso(3))/leg2.leg1.pt()<0.40)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.046)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.021) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','EEEESecondZEleIso')
...
EEMManalysisConfigurator.addSelector('EEMMzzEleIso','PATEleEleMuMuQuadSelector','((leg1.leg1.userIso(1)-leg1.leg1.userFloat("rho")*(0.046)+leg1.leg1.userIso(2)-leg1.leg1.userFloat("rho")*(0.021) + leg1.leg1.userIso(3))/leg1.leg1.pt()<0.40)&&((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.046)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.21) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)','EEMMLeadingZEleIso')
...
EEMManalysisConfigurator.addSelector('EEMMzzMuIso2','PATEleEleMuMuQuadSelector','((leg1.leg2.userIso(1)-leg1.leg2.userFloat("rho")*(0.045)+leg1.leg2.userIso(2)-leg1.leg2.userFloat("rho")*(0.022) + leg1.leg2.userIso(3))/leg1.leg2.pt()<0.40)&&((leg2.leg2.userIso(1)-leg2.leg2.userFloat("rho")*(0.045)+leg2.leg2.userIso(2)-leg2.leg2.userFloat("rho")*(0.022) + leg2.leg2.userIso(3))/leg2.leg2.pt()<0.40)','EEMMLeadingZMuIso')
