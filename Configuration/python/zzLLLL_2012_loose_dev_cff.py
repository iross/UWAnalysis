...
ZMM = CutSequenceProducer(initialCounter  = 'initialEventsZMM',
                                  ...
                                  pyNameSpace  = locals())
ZMM.addDiCandidateModule('ZMMInit','PATMuPairProducer', 'looseMuons','looseMuons','systematicsMET','selectedPatJets',1,genParticles='genDaughters')
...
EEMtri.addDiCandidateModule('triEEMdiElectrons','PATElePairProducer', 'looseElectrons','looseElectrons','systematicsMET','selectedPatJets',1,genParticles='genDaughters')
...
EEMtri.addDiCandidateModule('triEEMzzCands','PATEleEleMuTriProducer','EEMosDiElectrons','looseMuons','systematicsMET','selectedPatJets',1,9999,text='EEMAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.01,recoMode ="",genParticles='genDaughters')
EEMtri.addCrossCleanerModule('triEEMzzCleanedCands','PATEleEleMuTriCrossCleaner',1,9999,text='EEMAtLeastOneZZCleanedCandidate',dR = 0.02)
...
EEEtri.addDiCandidateModule('triEEEdiElectrons','PATElePairProducer', 'looseElectrons','looseElectrons','systematicsMET','selectedPatJets',1,genParticles='genDaughters')
...
EEEtri.addDiCandidateModule('triEEEzzCands','PATEleEleEleTriProducer','EEEosDiElectrons','looseElectrons','systematicsMET','selectedPatJets',1,9999,text='EEEAtLeastOneZZ',leadingObjectsOnly = False,dR = 0.01,recoMode ="",genParticles='genDaughters')
EEEtri.addCrossCleanerModule('triEEEzzCleanedCands','PATEleEleEleTriCrossCleaner',1,9999,text='EEEAtLeastOneZZCleanedCandidate',dR = 0.02)
...
MMMManalysisConfigurator.addSmearing('cleanPatTaus','looseMuons','looseElectrons','selectedPatJets','MMMM')
...
MMMManalysisConfigurator.addSelector('MMMMdiMuons','PATMuPairSelector','abs(leg1.eta())<2.4 && leg1.pt()>5','',1)
MMMManalysisConfigurator.addFSRRecovery('MMMMfsredMM','MuMuZFSRRecovery','MMMMdiMuons','boostedFsrPhotons','smearedElectronsMMMM','looseMuons')
MMMManalysisConfigurator.addSelector('MMMMosDiMuons','PATMuPairSelector','leg1.pfCandidateRef().isNonnull()&&charge==0&&(leg1.isGlobalMuon()||leg1.isTrackerMuon())&& abs(leg1.eta())<2.4 && leg1.pt()>5 && abs(leg1.userFloat("ip3DS"))<4 && abs(leg1.userFloat("ipDXY"))<0.5 && abs(leg1.userFloat("dz"))<1.0','one PX pair found',1)
MMMManalysisConfigurator.addSelector('MMMMosDiMuonsIso','PATMuPairSelector','(leg1.chargedHadronIso()+max(0.0,leg1.neutralHadronIso()+leg1PhotonIso()-leg1.userFloat("zzRho2012")*leg1.userFloat("effArea")))/leg1.pt<0.40','one Z1 with iso',1)
...
EEEEanalysisConfigurator.addSmearing('cleanPatTaus','looseMuons','looseElectrons','selectedPatJets','EEEE')
...
EEEEanalysisConfigurator.addFSRRecovery('EEEEfsredEE','EleEleZFSRRecovery','EEEEdiElectrons','boostedFsrPhotons','smearedElectronsEEEE','looseMuons','fsrrrrrr')
EEEEanalysisConfigurator.addSelector('EEEEosDiElectronsnoID','PATElePairSelector','charge==0&& leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2 && leg1.pt()>7 && abs(leg1.eta())<2.5 && abs(leg1.userFloat("ip3DS"))<4 && abs(leg1.userFloat("ipDXY"))<0.5 && abs(leg1.userFloat("dz"))<1.0','eeee PX pair found',1)
EEEEanalysisConfigurator.addSelector('EEEEosDiElectrons','PATElePairSelector','leg1.userFloat("mvaNonTrigV0Pass")>0','Z1 ID',1)


EEEEanalysisConfigurator.addSelector('EEEEosDiElectronsIso','PATElePairSelector','(leg1.chargedHadronIso()+max(0.0,leg1.neutralHadronIso()+leg1PhotonIso()-leg1.userFloat("zzRho2012")*leg1.userFloat("effArea")))/leg1.pt<0.40','one Z1 with iso eeee',1)
...
MMEEanalysisConfigurator.addSmearing('cleanPatTaus','looseMuons','looseElectrons','selectedPatJets','MMEE')
...
MMEEanalysisConfigurator.addFSRRecovery('MMEEfsredMM','MuMuZFSRRecovery','MMEEosDiMuons','boostedFsrPhotons','smearedElectronsMMEE','looseMuons')
...
EEMManalysisConfigurator.addSmearing('cleanPatTaus','looseMuons','looseElectrons','selectedPatJets','EEMM')
...
#3a. Pair #1 built, (SF/OS, closest to Z0)
#todo
EEMManalysisConfigurator.addSelector('EEMMosDiElectrons','PATElePairSelector','charge==0&&leg1.userFloat("mvaNonTrigV0Pass")>0 && leg1.gsfTrack().trackerExpectedHitsInner().numberOfHits()<2 && leg1.pt()>7 && abs(leg1.eta())<2.5 && abs(leg1.userFloat("ip3DS"))<4 && abs(leg1.userFloat("ipDXY"))<0.5 && abs(leg1.userFloat("dz"))<1.0','eemm PX found',1)
EEMManalysisConfigurator.addFSRRecovery('EEMMfsredEE','EleEleZFSRRecovery','EEMMosDiElectrons','boostedFsrPhotons','smearedElectronsEEMM','looseMuons')
EEMManalysisConfigurator.addSelector('EEMMosDiElectronsIso','PATElePairSelector','(leg1.chargedHadronIso()+max(0.0,leg1.neutralHadronIso()+leg1PhotonIso()-leg1.userFloat("zzRho2012")*leg1.userFloat("effArea")))/leg1.pt<0.40','one Z1 with iso EEMM',1)
...
EEMManalysisConfigurator.addSelector('EEMMdiMuons','PATMuPairSelector','abs(leg1.eta())<2.4 && leg1.pt()>5','',1)
...
MMEEonlyanalysisConfigurator.addSmearing('cleanPatTaus','looseMuons','looseElectrons','selectedPatJets','MMEEonly')
...
MMEEonlyanalysisConfigurator.addSelector('MMEEonlyosDiMuonsnoPF','PATMuPairSelector','charge==0&&(leg1.isGlobalMuon()||leg1.isTrackerMuon())&& abs(leg1.eta())<2.4 && leg1.pt()>5 && abs(leg1.userFloat("ip3DS"))<4 && abs(leg1.userFloat("ipDXY"))<0.5 && abs(leg1.userFloat("dz"))<1.0','one Z1 MMEEonly no pf',1)
MMEEonlyanalysisConfigurator.addSelector('MMEEonlyosDiMuons','PATMuPairSelector','leg1.pfCandidateRef().isNonnull()&&charge==0&&(leg1.isGlobalMuon()||leg1.isTrackerMuon())&& abs(leg1.eta())<2.4 && leg1.pt()>5 && abs(leg1.userFloat("ip3DS"))<4 && abs(leg1.userFloat("ipDXY"))<0.5 && abs(leg1.userFloat("dz"))<1.0','one Z1 MMEE only',1)
MMEEonlyanalysisConfigurator.addFSRRecovery('MMEEonlyfsredMM','MuMuZFSRRecovery','MMEEonlyosDiMuons','boostedFsrPhotons','smearedElectronsMMEE','looseMuons')
...
MMMTanalysisConfigurator.addSmearing('cleanPatTaus','looseMuons','looseElectrons','selectedPatJets','MMMT')
...
MMTTanalysisConfigurator.addSmearing('cleanPatTaus','looseMuons','looseElectrons','selectedPatJets','MMTT')
...
MMETanalysisConfigurator.addSmearing('cleanPatTaus','looseMuons','looseElectrons','selectedPatJets','MMET')
...
MMEManalysisConfigurator.addSmearing('cleanPatTaus','looseMuons','looseElectrons','selectedPatJets','MMEM')
...
EEMTanalysisConfigurator.addSmearing('cleanPatTaus','looseMuons','looseElectrons','selectedPatJets','EEMT')
...
EEETanalysisConfigurator.addSmearing('cleanPatTaus','looseMuons','looseElectrons','selectedPatJets','EEET')
...
EETTanalysisConfigurator.addSmearing('cleanPatTaus','looseMuons','looseElectrons','selectedPatJets','EETT')
...
EEEManalysisConfigurator.addSmearing('cleanPatTaus','looseMuons','looseElectrons','selectedPatJets','EEEM')
...
#EEEManalysisConfigurator.addHLTFilter("EEEMHLT",DATAMC2012TriggerPaths,"HLT_reqEEEM")
EEESanalysisConfigurator.addSmearing('cleanPatTaus','looseMuons','looseElectrons','selectedPatJets','EEES')
