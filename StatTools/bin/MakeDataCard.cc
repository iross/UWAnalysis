...
int main (int argc, char* argv[]) 
{
   ...
   parser.addOption("vbfSelection0",optutl::CommandLineParser::kString,"SM Category 0 ","((nJetsPt30<2)||(nJetsPt30==2&&!(vbfDEta>3.5&&vbfMass>350)))");
   parser.addOption("vbfSelection1",optutl::CommandLineParser::kString,"SM category 1","(nJetsPt30<2&&(pt+met>200&&dPhi1MET<1.4&&dPhi2MET<1.4))");
   parser.addOption("vbfSelection2",optutl::CommandLineParser::kString,"SM Category 2","(nJetsPt30==2&&vbfDEta>3.5&&vbfMass>350)");
   ...
   parser.addOption("bFactorZ",optutl::CommandLineParser::kDouble,"B factor Z",0.85);
   parser.addOption("bFactorW",optutl::CommandLineParser::kDouble,"B Factor W",1.);
   parser.addOption("bFactorZErr",optutl::CommandLineParser::kDouble,"Probability of Z +1 b Error",0.05);
   ...
   parser.addOption("vhFactorZ",optutl::CommandLineParser::kDouble,"VH factor for Z",1.);
   parser.addOption("vhFactorW",optutl::CommandLineParser::kDouble,"VH Factor for W",1.);
   parser.addOption("vhFactorZErr",optutl::CommandLineParser::kDouble,"VH factor for ZErr",0.15);
   parser.addOption("vhFactorWErr",optutl::CommandLineParser::kDouble,"VH  factor for W Error",0.15);
